...
<!-- Import p5.asciify -->
<script src="https://cdn.jsdelivr.net/npm/p5.asciify@0.0.6/dist/p5.asciify.min.js">
...
| Option                | Type    | Default value  | Description                                                                                                                                                                                                 |
|-----------------------|---------|----------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `enabled`             | boolean | false     | A boolean value indicating whether the brightness-based ASCII conversion should be enabled.                                                                                                      |
