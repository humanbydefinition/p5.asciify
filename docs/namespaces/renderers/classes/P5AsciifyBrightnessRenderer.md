...
Defined in: [renderers/brightness/BrightnessAsciiRenderer.ts:36](https://github.com/humanbydefinition/p5-asciify/blob/10002e5b44822cb907b50597a894bf5528f31cb6/src/lib/renderers/brightness/BrightnessAsciiRenderer.ts#L36)
...
Defined in: [renderers/brightness/BrightnessAsciiRenderer.ts:41](https://github.com/humanbydefinition/p5-asciify/blob/10002e5b44822cb907b50597a894bf5528f31cb6/src/lib/renderers/brightness/BrightnessAsciiRenderer.ts#L41)
...
| <a id="asciicharactershader"></a> `asciiCharacterShader` | `private` | `Shader` | `undefined` | - | - | [renderers/brightness/BrightnessAsciiRenderer.ts:38](https://github.com/humanbydefinition/p5-asciify/blob/10002e5b44822cb907b50597a894bf5528f31cb6/src/lib/renderers/brightness/BrightnessAsciiRenderer.ts#L38) |
| <a id="colorsampleframebuffer"></a> `colorSampleFramebuffer` | `private` | `Framebuffer` | `undefined` | - | - | [renderers/brightness/BrightnessAsciiRenderer.ts:39](https://github.com/humanbydefinition/p5-asciify/blob/10002e5b44822cb907b50597a894bf5528f31cb6/src/lib/renderers/brightness/BrightnessAsciiRenderer.ts#L39) |
| <a id="colorsampleshader"></a> `colorSampleShader` | `private` | `Shader` | `undefined` | - | - | [renderers/brightness/BrightnessAsciiRenderer.ts:37](https://github.com/humanbydefinition/p5-asciify/blob/10002e5b44822cb907b50597a894bf5528f31cb6/src/lib/renderers/brightness/BrightnessAsciiRenderer.ts#L37) |
...
Defined in: [renderers/brightness/BrightnessAsciiRenderer.ts:62](https://github.com/humanbydefinition/p5-asciify/blob/10002e5b44822cb907b50597a894bf5528f31cb6/src/lib/renderers/brightness/BrightnessAsciiRenderer.ts#L62)
...
Defined in: [renderers/brightness/BrightnessAsciiRenderer.ts:57](https://github.com/humanbydefinition/p5-asciify/blob/10002e5b44822cb907b50597a894bf5528f31cb6/src/lib/renderers/brightness/BrightnessAsciiRenderer.ts#L57)
