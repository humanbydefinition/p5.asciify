...
Defined in: [renderers/brightness/BrightnessAsciiRenderer.ts:16](https://github.com/humanbydefinition/p5-asciify/blob/514129d7cbe0dc5aad57c2fc13d745c7c4510db2/src/lib/renderers/brightness/BrightnessAsciiRenderer.ts#L16)
...
Defined in: [renderers/brightness/BrightnessAsciiRenderer.ts:21](https://github.com/humanbydefinition/p5-asciify/blob/514129d7cbe0dc5aad57c2fc13d745c7c4510db2/src/lib/renderers/brightness/BrightnessAsciiRenderer.ts#L21)
...
| <a id="asciicharactershader"></a> `asciiCharacterShader` | `private` | `Shader` | - | [renderers/brightness/BrightnessAsciiRenderer.ts:18](https://github.com/humanbydefinition/p5-asciify/blob/514129d7cbe0dc5aad57c2fc13d745c7c4510db2/src/lib/renderers/brightness/BrightnessAsciiRenderer.ts#L18) |
...
| <a id="colorsampleframebuffer"></a> `colorSampleFramebuffer` | `private` | `Framebuffer` | - | [renderers/brightness/BrightnessAsciiRenderer.ts:19](https://github.com/humanbydefinition/p5-asciify/blob/514129d7cbe0dc5aad57c2fc13d745c7c4510db2/src/lib/renderers/brightness/BrightnessAsciiRenderer.ts#L19) |
| <a id="colorsampleshader"></a> `colorSampleShader` | `private` | `Shader` | - | [renderers/brightness/BrightnessAsciiRenderer.ts:17](https://github.com/humanbydefinition/p5-asciify/blob/514129d7cbe0dc5aad57c2fc13d745c7c4510db2/src/lib/renderers/brightness/BrightnessAsciiRenderer.ts#L17) |
...
Defined in: [renderers/brightness/BrightnessAsciiRenderer.ts:41](https://github.com/humanbydefinition/p5-asciify/blob/514129d7cbe0dc5aad57c2fc13d745c7c4510db2/src/lib/renderers/brightness/BrightnessAsciiRenderer.ts#L41)
...
Defined in: [renderers/brightness/BrightnessAsciiRenderer.ts:36](https://github.com/humanbydefinition/p5-asciify/blob/514129d7cbe0dc5aad57c2fc13d745c7c4510db2/src/lib/renderers/brightness/BrightnessAsciiRenderer.ts#L36)
