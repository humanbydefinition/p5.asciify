...
Defined in: [gradients/radial/Radial.ts:9](https://github.com/humanbydefinition/p5-asciify/blob/19019252009e2dce4c7cdce7a1f6dcfa67e0e5df/src/lib/gradients/radial/Radial.ts#L9)
...
new P5AsciifyRadialGradient(
   ...
   brightnessEnd, 
   characters, 
   params): P5AsciifyRadialGradient
```

Defined in: [gradients/radial/Radial.ts:15](https://github.com/humanbydefinition/p5-asciify/blob/19019252009e2dce4c7cdce7a1f6dcfa67e0e5df/src/lib/gradients/radial/Radial.ts#L15)
...
| <a id="_shader-1"></a> `_shader` | `protected` | `Shader` | [`P5AsciifyGradient`](P5AsciifyGradient.md).[`_shader`](P5AsciifyGradient.md#_shader-1) | [gradients/radial/Radial.ts:18](https://github.com/humanbydefinition/p5-asciify/blob/19019252009e2dce4c7cdce7a1f6dcfa67e0e5df/src/lib/gradients/radial/Radial.ts#L18) |
| <a id="centerx"></a> `centerX` | `public` | `number` | - | [gradients/radial/Radial.ts:11](https://github.com/humanbydefinition/p5-asciify/blob/19019252009e2dce4c7cdce7a1f6dcfa67e0e5df/src/lib/gradients/radial/Radial.ts#L11) |
| <a id="centery"></a> `centerY` | `public` | `number` | - | [gradients/radial/Radial.ts:12](https://github.com/humanbydefinition/p5-asciify/blob/19019252009e2dce4c7cdce7a1f6dcfa67e0e5df/src/lib/gradients/radial/Radial.ts#L12) |
| <a id="direction"></a> `direction` | `public` | `number` | - | [gradients/radial/Radial.ts:10](https://github.com/humanbydefinition/p5-asciify/blob/19019252009e2dce4c7cdce7a1f6dcfa67e0e5df/src/lib/gradients/radial/Radial.ts#L10) |
...
| <a id="p-1"></a> `p` | `protected` | `__module` | [`P5AsciifyGradient`](P5AsciifyGradient.md).[`p`](P5AsciifyGradient.md#p-1) | [gradients/radial/Radial.ts:16](https://github.com/humanbydefinition/p5-asciify/blob/19019252009e2dce4c7cdce7a1f6dcfa67e0e5df/src/lib/gradients/radial/Radial.ts#L16) |
| <a id="radius"></a> `radius` | `public` | `number` | - | [gradients/radial/Radial.ts:13](https://github.com/humanbydefinition/p5-asciify/blob/19019252009e2dce4c7cdce7a1f6dcfa67e0e5df/src/lib/gradients/radial/Radial.ts#L13) |
...
Defined in: [gradients/radial/Radial.ts:32](https://github.com/humanbydefinition/p5-asciify/blob/19019252009e2dce4c7cdce7a1f6dcfa67e0e5df/src/lib/gradients/radial/Radial.ts#L32)
