...
class G extends c {
  constructor(e, r, i, o) {
    ...
    this.colorSampleShader = this.p.createShader(a, y), this.asciiCharacterShader = this.p.createShader(a, T), this.colorSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class R extends c {
  constructor(e, r, i, o) {
    ...
    this.sobelShader = this.p.createShader(a, k), this.sampleShader = this.p.createShader(a, p(16, this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(a, Y), this.asciiCharacterShader = this.p.createShader(a, z), this.sobelFramebuffer = this.p.createFramebuffer({
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
...
class H extends c {
  constructor(e, r, i, o, g) {
    ...
    this.gradientManager = o, this.grayscaleShader = this.p.createShader(a, N), this.colorSampleShader = this.p.createShader(a, O), this.asciiCharacterShader = this.p.createShader(a, X), this.grayscaleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
