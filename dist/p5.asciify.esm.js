...
class gA {
  constructor(A, e, r) {
    ...
    this.p = A, this.grid = e, this.fontTextureAtlas = r, this.currentCanvasDimensions = {
    ...
    }, this.gradientManager = new aA(A, this.fontTextureAtlas), this.gradientCharacterSet = new c(
      this.p,
      r,
      u.characters
    ), this._renderers = [
      ...
      new C(this.p, this.grid, new c(this.p, r, u.characters), { ...H })
...
n.prototype.registerMethod("init", function() {
  l.instance(this, !1), this._incrementPreload(), l.font = hA;
});
n.prototype.registerMethod("afterSetup", function() {
  EA(this), l.setup(), this.setupAsciify();
});
