...
var r = (s, A, e) => S(s, typeof A != "symbol" ? A + "" : A, e);
import g from "p5";
...
class b {
  ...
  getCharsetColorArray(A) {
    return (Array.isArray(A) ? A : Array.from(A)).map((t) => {
      ...
      if (!i)
        throw new h(`Could not find character in character set: ${t}`);
      return [i.r, i.g, i.b];
    });
  }
  /**
...
function y(s, A) {
  if (A != null && A.characterColor && (A.characterColor = s.color(A.characterColor)), A != null && A.backgroundColor && (A.backgroundColor = s.color(A.backgroundColor)), A != null && A.fontSize && (A.fontSize < C.MIN || A.fontSize > C.MAX))
    throw new h(`Font size ${A.fontSize} is out of bounds. It should be between ${C.MIN} and ${C.MAX}.`);
}
class B {
  constructor(A, e, t, i) {
    r(this, "_options");
...
class M extends B {
  constructor(e, t, i, o) {
    ...
    this.colorSampleShader = this.p.createShader(n, T), this.asciiCharacterShader = this.p.createShader(n, U), this.shader = this.p.createShader(n, d), this.colorSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class Y extends B {
  constructor(e, t, i, o) {
    ...
    this.characterSelectionShader = this.p.createShader(n, D(this.characterSet.asciiFontTextureAtlas.fontSize, this.characterSet.characters.length)), this.brightnessSampleShader = this.p.createShader(n, m(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(n, p(16, this.grid.cellHeight, this.grid.cellWidth)), this.brightnessSplitShader = this.p.createShader(n, G), this.shader = this.p.createShader(n, d), this.brightnessSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
  ...
  resetShaders() {
    this.characterSelectionShader = this.p.createShader(n, D(this.characterSet.asciiFontTextureAtlas.fontSize)), this.brightnessSampleShader = this.p.createShader(n, m(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(n, p(16, this.grid.cellHeight, this.grid.cellWidth));
  }
  render(e, t, i) {
...
class k extends B {
  constructor(e, t, i, o) {
    super(e, t, i, o);
    r(this, "shader");
    this.shader = this.p.createShader(n, d);
  }
  render(e, t, i) {
...
class N extends B {
  constructor(e, t, i, o) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.sobelShader = this.p.createShader(n, O), this.sampleShader = this.p.createShader(n, _(16, this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(n, z), this.asciiCharacterShader = this.p.createShader(n, R), this.shader = this.p.createShader(n, d), this.sobelFramebuffer = this.p.createFramebuffer({
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
  ...
  resetShaders() {
    this.sampleShader = this.p.createShader(n, _(16, this.grid.cellHeight, this.grid.cellWidth));
  }
  render(e, t, i) {
...
var X = "precision mediump float;uniform sampler2D u_image;varying vec2 v_texCoord;void main(){vec4 color=texture2D(u_image,v_texCoord);float luminance=0.299*color.r+0.587*color.g+0.114*color.b;color.rgb=vec3(luminance);gl_FragColor=color;}", L = `#version 100
...
class H extends B {
  constructor(e, t, i, o, a) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.gradientManager = o, this.grayscaleShader = this.p.createShader(n, X), this.colorSampleShader = this.p.createShader(n, L), this.asciiShader = this.p.createShader(n, d), this.grayscaleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class c {
  constructor(A, e, t) {
    ...
    this.p = A, this.asciiFontTextureAtlas = e, this._characters = this.validateCharacters(t), this.characterColors = this.asciiFontTextureAtlas.getCharsetColorArray(this._characters), this.characterColorPalette = new x(this.characterColors), this.characterColorPalette.setup(this.p);
  }
  /**
  ...
  validateCharacters(A) {
    ...
    if (e.length > 0)
      throw new h(`The following characters are not supported by the current font: [${e.join(", ")}].`);
    return Array.from(A);
  }
  /**
...
class E {
  ...
  setup(A, e, t) {
    this._shader = e, this._palette = new x(t), this._palette.setup(A);
  }
  setUniforms(A, e, t) {
...
class oA {
  constructor() {
    ...
    r(this, "_gradientConstructors", {
      linear: (A, e, t, i, o) => new W(A, e, t, i, o),
      zigzag: (A, e, t, i, o) => new K(A, e, t, i, o),
      spiral: (A, e, t, i, o) => new Z(A, e, t, i, o),
      radial: (A, e, t, i, o) => new V(A, e, t, i, o),
      conical: (A, e, t, i, o) => new q(A, e, t, i, o),
      noise: (A, e, t, i, o) => new $(A, e, t, i, o)
    });
    r(this, "_setupQueue", []);
    r(this, "_gradients", []);
  ...
  addGradient(A, e, t, i, o) {
    const a = this.getGradientParams(A, {
      ...
      characters: i,
      ...o
    }), l = this._gradientConstructors[A](
    ...
    return l.registerPaletteChangeCallback(this.handleGradientPaletteChange.bind(this)), this._gradients.push(l), this.p5Instance._setupDone ? l.setup(
      this.p5Instance,
      this.gradientShaders[A],
      this.fontTextureAtlas.getCharsetColorArray(i)
    ) : this._setupQueue.push({ gradientInstance: l, type: A }), l;
  }
  removeGradient(A) {
...
class aA {
  ...
  setup(A, e, t) {
    ...
    }, this.gradientCharacterSet = new c(
      this.p,
      t,
      f.characters
    ), this.gradientManager.setup(this.fontTextureAtlas), this._renderers = [
      new M(this.p, this.grid, new c(this.p, t, f.characters), { ...f }),
      new Y(this.p, this.grid, new c(this.p, t, P.characters), { ...P }),
      new H(this.p, this.grid, this.gradientCharacterSet, this.gradientManager, { ...J }),
      new N(this.p, this.grid, new c(this.p, t, I.characters), { ...I }),
      new k(this.p, this.grid, new c(this.p, t, f.characters), { ...j })
    ];
  }
  /**
...
class gA {
   ...
   */
  setup() {
    this.asciiFontTextureAtlas = new b(this.p, this._font, this._fontSize), this.grid = new v(
      this.p,
   ...
   */
  set font(A) {
    this._font = A, this.p._setupDone && (this.asciiFontTextureAtlas.setFontObject(A), this.rendererManager.renderers.forEach((e) => e.characterSet.setCharacterSet(e.characterSet.characters)), this.grid.resizeCellPixelDimensions(
      this.asciiFontTextureAtlas.maxGlyphDimensions.width,
      this.asciiFontTextureAtlas.maxGlyphDimensions.height
    ));
  }
...
function nA(s) {
  if (s._renderer.drawingContext instanceof CanvasRenderingContext2D)
    throw new h("WebGL renderer is required for p5.asciify to work.");
  function A(e, t) {
    const [i, o] = [e, t].map((a) => a.split(".").map(Number));
    for (let a = 0; a < Math.max(i.length, o.length); a++) {
      const l = i[a] ?? 0, u = o[a] ?? 0;
      if (l !== u) return l > u ? 1 : -1;
    }
    return 0;
  }
  if (A(s.VERSION, "1.8.0") < 0)
    throw new h("p5.asciify requires p5.js v1.8.0 or higher to work.");
}
function hA(s) {
  ...
  g.prototype.preloadAsciiFont = function() {
    ...
    if (typeof A == "string")
      this.loadFont(
        ...
        () => {
          throw new h(`loadAsciiFont() | Failed to load font from path: '${A}'`);
        }
      );
    else if (A instanceof g.Font)
      e(A);
    else
      throw new h("loadAsciiFont() | Invalid font parameter. Expected a path, base64 string, or p5.Font object.");
...
function QA(s, A, e, t, i, o) {
  ...
  const a = Object.keys(s.gradientParams[A]), l = Object.keys(o).filter((u) => !a.includes(u));
  if (l.length > 0)
    throw new h(
      `Invalid parameter(s) for gradient '${A}': ${l.join(", ")}
...
const Q = new gA();
typeof window < "u" && (window.p5asciify = Q, window.preload = function() {
});
hA(Q);
BA(Q);
EA(Q);
