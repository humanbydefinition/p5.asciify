...
var S = (s, A, e) => A in s ? w(s, A, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[A] = e;
var t = (s, A, e) => S(s, typeof A != "symbol" ? A + "" : A, e);
import B from "p5";
...
class v {
  ...
  drawCharacters(A) {
    ...
    for (let e = 0; e < this._characterGlyphs.length; e++) {
      const r = e % this._charsetCols, i = Math.floor(e / this._charsetCols), o = this._maxGlyphDimensions.width * r - this._maxGlyphDimensions.width * this._charsetCols / 2, g = this._maxGlyphDimensions.height * i - this._maxGlyphDimensions.height * this._charsetRows / 2;
      this.p.text(String.fromCharCode(this._characterGlyphs[e].unicode), o, g);
    }
  }
  /**
  ...
  getCharsetColorArray(A) {
    return (Array.isArray(A) ? A : Array.from(A)).map((r) => {
      ...
      if (!i)
        throw new Q(`Could not find character in character set: ${r}`);
      return [i.r, i.g, i.b];
    });
  }
  /**
...
class c {
  constructor(A, e, r, i) {
    ...
    t(this, "_shader");
    this.p = A, this.grid = e, this.characterSet = r, this._options = i, this._primaryColorSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      antialias: !1,
      ...
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
    }), this._shader = this.p.createShader(a, F);
  }
  /**
   ...
   */
  updateOptions(A) {
    A != null && A.characterColor && (A.characterColor = this.p.color(A.characterColor)), A != null && A.backgroundColor && (A.backgroundColor = this.p.color(A.backgroundColor)), this._options = {
      ...this._options,
      ...A
...
class G extends c {
  constructor(e, r, i, o) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.colorSampleShader = this.p.createShader(a, y), this.asciiCharacterShader = this.p.createShader(a, T), this.colorSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class U extends c {
  constructor(e, r, i, o) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.characterSelectionShader = this.p.createShader(a, f(this.characterSet.asciiFontTextureAtlas.fontSize, this.characterSet.characters.length)), this.brightnessSampleShader = this.p.createShader(a, m(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(a, p(16, this.grid.cellHeight, this.grid.cellWidth)), this.brightnessSplitShader = this.p.createShader(a, M), this.brightnessSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
  ...
  resetShaders() {
    this.characterSelectionShader = this.p.createShader(a, f(this.characterSet.asciiFontTextureAtlas.fontSize)), this.brightnessSampleShader = this.p.createShader(a, m(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(a, p(16, this.grid.cellHeight, this.grid.cellWidth));
  }
  render(e, r) {
...
class R extends c {
  constructor(e, r, i, o) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.sobelShader = this.p.createShader(a, k), this.sampleShader = this.p.createShader(a, P(16, this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(a, Y), this.asciiCharacterShader = this.p.createShader(a, z), this.sobelFramebuffer = this.p.createFramebuffer({
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
  ...
  resetShaders() {
    this.sampleShader = this.p.createShader(a, P(16, this.grid.cellHeight, this.grid.cellWidth));
  }
  render(e, r) {
...
var N = "precision mediump float;uniform sampler2D u_image;varying vec2 v_texCoord;void main(){vec4 color=texture2D(u_image,v_texCoord);float luminance=0.299*color.r+0.587*color.g+0.114*color.b;color.rgb=vec3(luminance);gl_FragColor=color;}", O = "precision mediump float;uniform sampler2D u_sketchTexture;uniform sampler2D u_previousColorTexture;uniform sampler2D u_sampleTexture;uniform sampler2D u_sampleReferenceTexture;uniform vec2 u_gridCellDimensions;uniform int u_sampleMode;uniform vec4 u_staticColor;void main(){vec2 cellCoord=floor(gl_FragCoord.xy);vec2 cellSizeInTexCoords=vec2(1.0)/u_gridCellDimensions;vec2 cellCenterTexCoord=(cellCoord+vec2(0.5))*cellSizeInTexCoords;bool isMatchingSample=texture2D(u_sampleTexture,cellCenterTexCoord)==texture2D(u_sampleReferenceTexture,cellCenterTexCoord);if(isMatchingSample){gl_FragColor=texture2D(u_previousColorTexture,cellCenterTexCoord);return;}else if(u_sampleMode==0){gl_FragColor=texture2D(u_sketchTexture,cellCenterTexCoord);}else{gl_FragColor=u_staticColor;}}", X = "precision mediump float;uniform sampler2D u_prevAsciiCharacterTexture;uniform sampler2D u_prevGradientTexture;uniform sampler2D u_nextGradientTexture;uniform vec2 u_resolution;void main(){vec2 uv=gl_FragCoord.xy/u_resolution;vec4 prevAscii=texture2D(u_prevAsciiCharacterTexture,uv);vec4 prevGradient=texture2D(u_prevGradientTexture,uv);vec4 nextGradient=texture2D(u_nextGradientTexture,uv);bool colorsMatch=prevGradient==nextGradient;gl_FragColor=colorsMatch ? prevAscii : nextGradient;}";
class H extends c {
  constructor(e, r, i, o, g) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.gradientManager = o, this.grayscaleShader = this.p.createShader(a, N), this.colorSampleShader = this.p.createShader(a, O), this.asciiCharacterShader = this.p.createShader(a, X), this.grayscaleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class x {
  ...
  updateFramebuffer() {
    ...
    for (let r = 0; r < A; r++) {
      const i = r < this._colors.length ? this.p5Instance.color(this._colors[r]) : this.p5Instance.color(0, 0, 0, 0), o = 4 * r;
...
class l {
  constructor(A, e, r) {
    ...
    this.p = A, this.asciiFontTextureAtlas = e, this._characters = this.validateCharacters(r), this.characterColors = this.asciiFontTextureAtlas.getCharsetColorArray(this._characters), this.characterColorPalette = new x(this.characterColors), this.characterColorPalette.setup(this.p);
  }
  /**
...
const D = (s, A, e, r) => {
  if (typeof s != "number" || s < A || s > e)
    throw new Q(
      `Invalid ${r} value '${s}'. Expected a number between ${A} and ${e}.`
    );
};
class E {
  constructor(A, e, r) {
    ...
    t(this, "_shader");
    this._characters = r, this._brightnessStart = Math.floor(A / 255 * 100) / 100, this._brightnessEnd = Math.ceil(e / 255 * 100) / 100, this.enabled = !0;
  }
  /**
   ...
   */
  setup(A, e, r, i) {
    this._p = A, this._fontTextureAtlas = e, this._shader = r, this._palette = new x(i), this._palette.setup(A);
  }
  /**
...
class j extends E {
  ...
  setUniforms(e, r) {
    super.setUniforms(e, r), this._shader.setUniform("u_gradientDirection", this.direction), this._shader.setUniform("u_angle", this.angle * Math.PI / 180), this._shader.setUniform("u_speed", this.speed);
  }
}
class W extends E {
  constructor(e, r, i, o) {
...
class sA {
  constructor() {
    ...
    t(this, "_gradientConstructors", {
      linear: (A, e, r, i) => new j(A, e, r, i),
      zigzag: (A, e, r, i) => new W(A, e, r, i),
      spiral: (A, e, r, i) => new V(A, e, r, i),
      radial: (A, e, r, i) => new L(A, e, r, i),
      conical: (A, e, r, i) => new Z(A, e, r, i),
      noise: (A, e, r, i) => new $(A, e, r, i)
    });
    t(this, "_setupQueue", []);
    t(this, "_gradients", []);
  ...
  addGradient(A, e, r, i, o) {
    ...
    ) : this._setupQueue.push({ gradientInstance: g, type: A }), g;
  }
  /**
...
class oA {
  ...
  setup(A, e, r) {
    this.p = A, this.grid = e, this.fontTextureAtlas = r, this.currentCanvasDimensions = {
      ...
      new G(this.p, this.grid, new l(this.p, r, d.characters), { ...d }),
      new U(this.p, this.grid, new l(this.p, r, I.characters), { ...I }),
      new H(this.p, this.grid, this.gradientCharacterSet, this.gradientManager, { ...J }),
      new R(this.p, this.grid, new l(this.p, r, _.characters), { ..._ }),
      new c(this.p, this.grid, new l(this.p, r, d.characters), { ...K })
    ];
  }
  /**
   ...
   */
  render(A, e) {
    let r = A, i = this._renderers[0];
    for (const o of this._renderers)
      o.options.enabled && (o.render(A, i), r = o.outputFramebuffer, i = o, this.lastRenderer = o);
...
class aA {
  constructor() {
    ...
    this.borderColor = "#000000", this._fontSize = 16, this.rendererManager = new oA(), this.postSetupFunction = null, this.postDrawFunction = null;
  }
  /**
   ...
   */
  setup() {
    this.asciiFontTextureAtlas = new v(this.p, this._font, this._fontSize), this.grid = new b(
      this.p,
  ...
  set fontSize(A) {
    if (A < u.MIN || A > u.MAX)
      throw new Q(`Font size ${A} is out of bounds. It should be between ${u.MIN} and ${u.MAX}.`);
...
`;
function EA(s) {
  B.prototype.loadAsciiFont = function(A) {
    const e = (r) => {
      s.font = r, this._decrementPreload();
    };
    if (typeof A == "string")
      this.loadFont(
        A,
    ...
    else if (A instanceof B.Font)
      e(A);
    else
      throw new Q("loadAsciiFont() | Invalid font parameter. Expected a path, base64 string, or p5.Font object.");
  }, B.prototype.registerMethod("init", function() {
    this._incrementPreload(), this.loadAsciiFont(QA);
  });
}
function nA(s) {
  B.prototype.setAsciifyBorderColor = function(A) {
    s.borderColor = A;
  }, B.prototype.setAsciifyFontSize = function(A) {
    s.fontSize = A;
  }, B.prototype.setAsciifyPostSetupFunction = function(A) {
    s.postSetupFunction = A;
  }, B.prototype.setAsciifyPostDrawFunction = function(A) {
    s.postDrawFunction = A;
  };
}
function hA(s, A, e, r, i, o) {
...
function lA(s) {
  B.prototype.addAsciiGradient = function(A, e, r, i, o = {}) {
    return hA(
  ...
  }, B.prototype.removeAsciiGradient = function(A) {
