...
class C {
  constructor(A, e, r, s) {
    ...
    this.p = A, this.grid = e, this.characterSet = r, this._options = s, this._options.characterColor && (this._options.characterColor = this.p.color(this._options.characterColor)), this._options.backgroundColor && (this._options.backgroundColor = this.p.color(this._options.backgroundColor)), this._primaryColorSampleFramebuffer = this.p.createFramebuffer({
      ...
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
    }), this._shader = this.p.createShader(E, G);
  }
  /**
...
class Y extends C {
  constructor(e, r, s, o) {
    ...
    this.colorSampleShader = this.p.createShader(E, M), this.asciiCharacterShader = this.p.createShader(E, U), this.colorSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class k extends C {
  ...
  resetShaders() {
    this.characterSelectionShader = this.p.createShader(E, m(this.characterSet.asciiFontTextureAtlas.fontSize)), this.brightnessSampleShader = this.p.createShader(E, P(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(E, I(16, this.grid.cellHeight, this.grid.cellWidth));
  }
  render(e, r) {
...
class J extends C {
  constructor(e, r, s, o) {
    ...
    this.sobelShader = this.p.createShader(E, O), this.sampleShader = this.p.createShader(E, p(16, this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(E, R), this.asciiCharacterShader = this.p.createShader(E, N), this.sobelFramebuffer = this.p.createFramebuffer({
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
...
class sA {
  constructor(A, e) {
    ...
    i(this, "_gradientConstructors", {
      linear: (A, e, r, s, o, a, B, h) => new V(A, e, r, s, o, a, B, h),
      spiral: (A, e, r, s, o, a, B, h) => new $(A, e, r, s, o, a, B, h),
      radial: (A, e, r, s, o, a, B, h) => new q(A, e, r, s, o, a, B, h),
      conical: (A, e, r, s, o, a, B, h) => new AA(A, e, r, s, o, a, B, h)
    });
    i(this, "_gradients", []);
    ...
    for (const r of Object.keys(this.gradientShaderSources)) {
      ...
      this.gradientShaders[r] = this.p.createShader(E, s);
    }
  }
  /**
...
function aA(t, A, e, r, s, o) {
  ...
  const a = Object.keys(t.gradientParams[A]), B = Object.keys(o).filter((h) => !a.includes(h));
  if (B.length > 0)
    throw new g(
