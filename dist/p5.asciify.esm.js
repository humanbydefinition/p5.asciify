...
class E {
  constructor(A, e, t, i) {
    ...
    r(this, "_shader");
    if (this.p = A, this.grid = e, this.characterSet = t, this._options = i, new.target === E)
    ...
    this._primaryColorSampleFramebuffer = this.p.createFramebuffer({
      ...
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
    }), this._shader = this.p.createShader(B, Y);
  }
  /**
...
class k extends E {
  constructor(e, t, i, o) {
    ...
    this.colorSampleShader = this.p.createShader(B, U), this.asciiCharacterShader = this.p.createShader(B, z), this.colorSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class O extends E {
  ...
  resetShaders() {
    this.characterSelectionShader = this.p.createShader(B, p(this.characterSet.asciiFontTextureAtlas.fontSize)), this.brightnessSampleShader = this.p.createShader(B, P(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(B, I(16, this.grid.cellHeight, this.grid.cellWidth));
  }
  render(e, t) {
...
class K extends E {
  constructor(e, t, i, o) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.sobelShader = this.p.createShader(B, J), this.sampleShader = this.p.createShader(B, _(16, this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(B, X), this.asciiCharacterShader = this.p.createShader(B, H), this.sobelFramebuffer = this.p.createFramebuffer({
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
  ...
  resetShaders() {
    this.sampleShader = this.p.createShader(B, _(16, this.grid.cellHeight, this.grid.cellWidth));
  }
  render(e, t) {
...
class EA {
  ...
  setup(A, e, t) {
    this.p = A, this.grid = e, this.fontTextureAtlas = t, this.currentCanvasDimensions = {
      ...
      new k(this.p, this.grid, new C(this.p, t, D.characters), { ...D }),
      new O(this.p, this.grid, new C(this.p, t, w.characters), { ...w }),
      new V(this.p, this.grid, this.gradientCharacterSet, this.gradientManager, { ...Z }),
      new K(this.p, this.grid, new C(this.p, t, x.characters), { ...x }),
      new N(this.p, this.grid, new C(this.p, t, D.characters), { ...$ })
    ];
  }
  /**
...
class hA {
  constructor() {
    ...
    this.borderColor = "#000000", this._fontSize = 16, this.rendererManager = new EA(), this.eventEmitter = new G(), this.postSetupFunction = null, this.postDrawFunction = null;
  }
  /**
...
function lA(s) {
  ...
  function A(e, t) {
    ...
    for (let a = 0; a < Math.max(i.length, o.length); a++) {
      const Q = i[a] ?? 0, d = o[a] ?? 0;
      if (Q !== d) return Q > d ? 1 : -1;
    }
    return 0;
  }
...
function DA(s, A, e, t, i, o) {
  ...
  const Q = Object.keys(s.gradientParams[A]), d = Object.keys(o).filter((h) => !Q.includes(h));
  if (d.length > 0)
    throw new n(
