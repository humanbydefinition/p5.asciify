...
var v = (r, A, e) => A in r ? S(r, A, { enumerable: !0, configurable: !0, writable: !0, value: e }) : r[A] = e;
var t = (r, A, e) => v(r, typeof A != "symbol" ? A + "" : A, e);
import Q from "p5";
...
class F {
  constructor(A, e, i) {
    ...
    this.p = A, this.font = e, this._fontSize = i;
  ...
  _getMaxGlyphDimensions(A) {
    return this._characterGlyphs.reduce(
      (e, i) => {
        const s = i.getPath(0, 0, A).getBoundingBox();
        return {
  ...
  drawCharacters(A) {
    ...
    for (let e = 0; e < this._characterGlyphs.length; e++) {
      const i = e % this._charsetCols, s = Math.floor(e / this._charsetCols), o = this._maxGlyphDimensions.width * i - this._maxGlyphDimensions.width * this._charsetCols / 2, B = this._maxGlyphDimensions.height * s - this._maxGlyphDimensions.height * this._charsetRows / 2;
  ...
  getCharsetColorArray(A) {
    return (Array.isArray(A) ? A : Array.from(A)).map((i) => {
      const s = this._characterGlyphs.find(
        (o) => o.unicodes.includes(i.codePointAt(0))
      );
      if (!s)
        throw new a(`Could not find character in character set: ${i}`);
      return [s.r, s.g, s.b];
    });
  }
  /**
...
class y {
  constructor(A, e, i) {
    ...
    t(this, "_offsetX", 0);
    t(this, "_offsetY", 0);
    this.p = A, this._cellWidth = e, this._cellHeight = i, this.reset();
  }
  /**
...
class l {
  constructor(A, e, i, s) {
    ...
    this.p = A, this.grid = e, this.characterSet = i, this._options = s, this._options.characterColor && (this._options.characterColor = this.p.color(this._options.characterColor)), this._options.backgroundColor && (this._options.backgroundColor = this.p.color(this._options.backgroundColor)), this._primaryColorSampleFramebuffer = this.p.createFramebuffer({
      ...
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
    }), this._shader = this.p.createShader(g, G);
  }
  /**
   ...
   */
  updateOptions(A) {
    T(A), A != null && A.characterColor && (A.characterColor = this.p.color(A.characterColor)), A != null && A.backgroundColor && (A.backgroundColor = this.p.color(A.backgroundColor)), this._options = {
      ...this._options,
      ...A
...
class Y extends l {
  constructor(e, i, s, o) {
    ...
    this.colorSampleShader = this.p.createShader(g, M), this.asciiCharacterShader = this.p.createShader(g, U), this.colorSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class k extends l {
  constructor(e, i, s, o) {
    ...
    this.characterSelectionShader = this.p.createShader(g, f(this.characterSet.asciiFontTextureAtlas.fontSize)), this.brightnessSampleShader = this.p.createShader(g, m(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(g, P(16, this.grid.cellHeight, this.grid.cellWidth)), this.brightnessSplitShader = this.p.createShader(g, z), this.brightnessSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class J extends l {
  constructor(e, i, s, o) {
    ...
    this.sobelShader = this.p.createShader(g, O), this.sampleShader = this.p.createShader(g, I(16, this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(g, R), this.asciiCharacterShader = this.p.createShader(g, N), this.sobelFramebuffer = this.p.createFramebuffer({
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
  ...
  updateOptions(e) {
    if (super.updateOptions(e), e != null && e.characters && e.characters.length !== w)
      throw new a(`For EdgeAsciiRenderer, 'characters' must be a string of length ${w}.`);
  }
  render(e, i) {
    this.sobelFramebuffer.begin(), this.p.clear(), this.p.shader(this.sobelShader), this.sobelShader.setUniform("u_texture", e), this.sobelShader.setUniform("u_textureSize", [this.p.width, this.p.height]), this.sobelShader.setUniform("u_threshold", this.options.sobelThreshold), this.p.rect(0, 0, this.p.width, this.p.height), this.sobelFramebuffer.end(), this.sampleFramebuffer.begin(), this.p.clear(), this.p.shader(this.sampleShader), this.sampleShader.setUniform("u_imageSize", [this.p.width, this.p.height]), this.sampleShader.setUniform("u_image", this.sobelFramebuffer), this.sampleShader.setUniform("u_gridCellDimensions", [this.grid.cols, this.grid.rows]), this.sampleShader.setUniform("u_threshold", this.options.sampleThreshold), this.p.rect(0, 0, this.p.width, this.p.height), this.sampleFramebuffer.end(), this._primaryColorSampleFramebuffer.begin(), this.p.clear(), this.p.shader(this.colorSampleShader), this.colorSampleShader.setUniform("u_sketchTexture", e), this.colorSampleShader.setUniform("u_previousColorTexture", i.primaryColorSampleFramebuffer), this.colorSampleShader.setUniform("u_sampleTexture", this.sampleFramebuffer), this.colorSampleShader.setUniform("u_gridCellDimensions", [this.grid.cols, this.grid.rows]), this.colorSampleShader.setUniform("u_sampleMode", this._options.characterColorMode), this.colorSampleShader.setUniform("u_staticColor", this._options.characterColor._array), this.p.rect(0, 0, this.p.width, this.p.height), this._primaryColorSampleFramebuffer.end(), this._secondaryColorSampleFramebuffer.begin(), this.p.clear(), this.p.shader(this.colorSampleShader), this.colorSampleShader.setUniform("u_sketchTexture", e), this.colorSampleShader.setUniform("u_previousColorTexture", i.secondaryColorSampleFramebuffer), this.colorSampleShader.setUniform("u_sampleTexture", this.sampleFramebuffer), this.colorSampleShader.setUniform("u_gridCellDimensions", [this.grid.cols, this.grid.rows]), this.colorSampleShader.setUniform("u_sampleMode", this._options.backgroundColorMode), this.colorSampleShader.setUniform("u_staticColor", this._options.backgroundColor._array), this.p.rect(0, 0, this.p.width, this.p.height), this._secondaryColorSampleFramebuffer.end(), this._asciiCharacterFramebuffer.begin(), this.p.clear(), this.p.shader(this.asciiCharacterShader), this.asciiCharacterShader.setUniform("u_sketchTexture", this.sampleFramebuffer), this.asciiCharacterShader.setUniform("u_colorPaletteTexture", this.characterSet.characterColorPalette.framebuffer), this.asciiCharacterShader.setUniform("u_previousAsciiCharacterTexture", i.asciiCharacterFramebuffer), this.asciiCharacterShader.setUniform("u_gridCellDimensions", [this.grid.cols, this.grid.rows]), this.asciiCharacterShader.setUniform("u_totalChars", this.characterSet.characters.length), this.p.rect(0, 0, this.p.width, this.p.height), this._asciiCharacterFramebuffer.end(), super.render(e, i);
  }
}
...
class V extends l {
  constructor(e, i, s, o, B) {
    ...
    this.gradientManager = o, this.grayscaleShader = this.p.createShader(g, j), this.colorSampleShader = this.p.createShader(g, K), this.asciiCharacterShader = this.p.createShader(g, W), this.grayscaleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
  ...
  render(e, i) {
    ...
    this._asciiCharacterFramebuffer.begin(), this.p.clear(), this.p.shader(this.asciiCharacterShader), this.asciiCharacterShader.setUniform("u_prevAsciiCharacterTexture", i.asciiCharacterFramebuffer), this.asciiCharacterShader.setUniform("u_prevGradientTexture", this.grayscaleFramebuffer), this.asciiCharacterShader.setUniform("u_nextGradientTexture", this.nextAsciiGradientFramebuffer), this.asciiCharacterShader.setUniform("u_resolution", [this.grid.cols, this.grid.rows]), this.p.rect(0, 0, this.grid.cols, this.grid.rows), this._asciiCharacterFramebuffer.end(), this._primaryColorSampleFramebuffer.begin(), this.p.clear(), this.p.shader(this.colorSampleShader), this.colorSampleShader.setUniform("u_sketchTexture", e), this.colorSampleShader.setUniform("u_previousColorTexture", i.primaryColorSampleFramebuffer), this.colorSampleShader.setUniform("u_sampleTexture", this.nextAsciiGradientFramebuffer), this.colorSampleShader.setUniform("u_sampleReferenceTexture", this.grayscaleFramebuffer), this.colorSampleShader.setUniform("u_gridCellDimensions", [this.grid.cols, this.grid.rows]), this.colorSampleShader.setUniform("u_sampleMode", this._options.characterColorMode), this.colorSampleShader.setUniform("u_staticColor", this._options.characterColor._array), this.p.rect(0, 0, this.p.width, this.p.height), this._primaryColorSampleFramebuffer.end(), this._secondaryColorSampleFramebuffer.begin(), this.p.clear(), this.p.shader(this.colorSampleShader), this.colorSampleShader.setUniform("u_sketchTexture", e), this.colorSampleShader.setUniform("u_previousColorTexture", i.secondaryColorSampleFramebuffer), this.colorSampleShader.setUniform("u_sampleTexture", this.nextAsciiGradientFramebuffer), this.colorSampleShader.setUniform("u_gridCellDimensions", [this.grid.cols, this.grid.rows]), this.colorSampleShader.setUniform("u_sampleMode", this._options.backgroundColorMode), this.colorSampleShader.setUniform("u_staticColor", this._options.backgroundColor._array), this.p.rect(0, 0, this.p.width, this.p.height), this._secondaryColorSampleFramebuffer.end(), super.render(e, i);
  }
}
class x {
  constructor(A) {
  ...
  updateFramebuffer() {
    ...
    for (let i = 0; i < A; i++) {
      const s = i < this._colors.length ? this.p5Instance.color(this._colors[i]) : this.p5Instance.color(0, 0, 0, 0), o = 4 * i;
...
class n {
  constructor(A, e, i) {
    ...
    this.p = A, this.asciiFontTextureAtlas = e, this._characters = this.validateCharacters(i), this.characterColors = this.asciiFontTextureAtlas.getCharsetColorArray(this._characters), this.characterColorPalette = new x(this.characterColors), this.characterColorPalette.setup(this.p);
  }
  /**
...
const D = (r, A, e, i) => {
  if (typeof r != "number" || r < A || r > e)
    throw new a(
      `Invalid ${i} value '${r}'. Expected a number between ${A} and ${e}.`
    );
};
class c {
  constructor(A, e, i) {
    ...
    t(this, "_shader");
    this._characters = i, this._brightnessStart = Math.floor(A / 255 * 100) / 100, this._brightnessEnd = Math.ceil(e / 255 * 100) / 100, this.enabled = !0;
  }
  /**
   ...
   */
  setup(A, e, i, s) {
    this._p = A, this._fontTextureAtlas = e, this._shader = i, this._palette = new x(s), this._palette.setup(A);
  }
  /**
...
class L extends c {
  constructor(e, i, s, o) {
    ...
    t(this, "speed");
    t(this, "zigzag");
    this.direction = o.direction, this.angle = o.angle, this.speed = o.speed, this.zigzag = o.zigzag;
  }
  setUniforms(e, i) {
    super.setUniforms(e, i), this._shader.setUniform("u_gradientDirection", this.direction), this._shader.setUniform("u_angle", this.angle * Math.PI / 180), this._shader.setUniform("u_speed", this.speed), this._shader.setUniform("u_zigzag", this.zigzag);
  }
}
class Z extends c {
  constructor(e, i, s, o) {
  ...
  setUniforms(e, i) {
    super.setUniforms(e, i), this._shader.setUniform("u_gradientDirection", this.direction), this._shader.setUniform("u_centerX", this.centerX), this._shader.setUniform("u_centerY", this.centerY), this._shader.setUniform("u_speed", this.speed), this._shader.setUniform("u_density", this.density);
  }
}
class $ extends c {
  constructor(e, i, s, o) {
  ...
  setUniforms(e, i) {
    super.setUniforms(e, i), this._shader.setUniform("u_gradientDirection", this.direction), this._shader.setUniform("u_centerX", this.centerX), this._shader.setUniform("u_centerY", this.centerY), this._shader.setUniform("u_radius", this.radius);
  }
}
class q extends c {
  constructor(e, i, s, o) {
  ...
  setUniforms(e, i) {
    super.setUniforms(e, i), this._shader.setUniform("u_centerX", this.centerX), this._shader.setUniform("u_centerY", this.centerY), this._shader.setUniform("u_speed", this.speed);
  }
}
class AA extends c {
  constructor(e, i, s, o) {
...
class oA {
  constructor(A) {
    ...
    t(this, "gradientShaders", {});
    t(this, "_gradientConstructors", {
      linear: (A, e, i, s) => new L(A, e, i, s),
      spiral: (A, e, i, s) => new Z(A, e, i, s),
      radial: (A, e, i, s) => new $(A, e, i, s),
      conical: (A, e, i, s) => new q(A, e, i, s),
      noise: (A, e, i, s) => new AA(A, e, i, s)
    });
    t(this, "_setupQueue", []);
    t(this, "_gradients", []);
...
class aA {
  ...
  setup(A, e) {
    ...
    }, this.gradientCharacterSet = new n(
      this.p,
      e,
      d.characters
    ), this.gradientManager.setup(this.fontTextureAtlas), this._renderers = [
      new Y(this.p, this.grid, new n(this.p, e, d.characters), { ...d }),
      new k(this.p, this.grid, new n(this.p, e, p.characters), { ...p }),
      new V(this.p, this.grid, this.gradientCharacterSet, this.gradientManager, { ...X }),
      new J(this.p, this.grid, new n(this.p, e, _.characters), { ..._ }),
      new l(this.p, this.grid, new n(this.p, e, d.characters), { ...H })
    ];
  }
  /**
   ...
   */
  render(A, e) {
    let i = A, s = this._renderers[0];
    for (const o of this._renderers)
      o.options.enabled && (o.render(A, s), i = o.outputFramebuffer, s = o, this.lastRenderer = o);
    this.p.clear(), this.p.background(e), this.p.image(i, -this.p.width / 2, -this.p.height / 2), this.checkCanvasDimensions();
  }
  /**
...
class gA {
  constructor() {
    ...
    t(this, "_font");
    t(this, "postSetupFunction");
    t(this, "postDrawFunction");
    t(this, "p");
   ...
   */
  setup() {
    this.asciiFontTextureAtlas = new F(this.p, this._font, this._fontSize), this.grid = new y(
      this.p,
...
function BA(r) {
  ...
  function A(e, i) {
    const [s, o] = [e, i].map((B) => B.split(".").map(Number));
    for (let B = 0; B < Math.max(s.length, o.length); B++) {
      const h = s[B] ?? 0, C = o[B] ?? 0;
...
function EA(r) {
  Q.prototype.loadAsciiFont = function(A) {
    ...
    this._incrementPreload(), this.loadAsciiFont(b);
  });
}
function hA(r) {
...
function nA(r, A, e, i, s, o) {
  ...
  if (D(e, 0, 255, "brightness start"), D(i, 0, 255, "brightness end"), typeof s != "string")
    throw new a("Characters must be a string");
  if (s.length === 0)
    throw new a("Characters string cannot be empty");
  if (!o || typeof o != "object" || Array.isArray(o))
    throw new a("User parameters must be an object");
  const B = Object.keys(r.gradientParams[A]), h = Object.keys(o).filter((C) => !B.includes(C));
  if (h.length > 0)
    throw new a(
...
function lA(r) {
  Q.prototype.addAsciiGradient = function(A, e, i, s, o = {}) {
    return nA(
