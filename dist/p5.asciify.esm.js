...
class QA {
  ...
  updateCaptureFramebuffer(e) {
    this._captureFramebuffer !== e && (this._captureFramebuffer = e);
  }
  /**
...
const T = class T {
  ...
  async init(e) {
    ...
    }), this._p._incrementPreload(), this._baseFont = e.loadFont(EA, (A) => {
  ...
  add(e) {
    ...
    const A = new QA(this._pluginRegistry);
