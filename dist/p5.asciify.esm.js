...
var v = (o, A, e) => A in o ? b(o, A, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[A] = e;
var t = (o, A, e) => v(o, typeof A != "symbol" ? A + "" : A, e);
import h from "p5";
...
class S {
  ...
  drawCharacters(A) {
    ...
    for (let e = 0; e < this._characterGlyphs.length; e++) {
      const r = e % this._charsetCols, i = Math.floor(e / this._charsetCols), s = this._maxGlyphDimensions.width * r - this._maxGlyphDimensions.width * this._charsetCols / 2, a = this._maxGlyphDimensions.height * i - this._maxGlyphDimensions.height * this._charsetRows / 2;
...
class p extends l {
  constructor(e, r, i, s = M) {
    ...
    this.colorSampleShader = this.p.createShader(Q, G), this.asciiCharacterShader = this.p.createShader(Q, U), this.colorSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class I extends l {
  constructor(e, r, i, s = k) {
    ...
    this.characterSelectionShader = this.p.createShader(Q, C(this.fontTextureAtlas.fontSize)), this.brightnessSampleShader = this.p.createShader(Q, u(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(Q, D(16, this.grid.cellHeight, this.grid.cellWidth)), this.brightnessSplitShader = this.p.createShader(Q, Y), this.brightnessSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
  ...
  resetShaders() {
    this.characterSelectionShader = this.p.createShader(Q, C(this.fontTextureAtlas.fontSize)), this.brightnessSampleShader = this.p.createShader(Q, u(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(Q, D(16, this.grid.cellHeight, this.grid.cellWidth));
  }
  render(e, r) {
...
class _ extends l {
  constructor(e, r, i, s = H) {
    ...
    this.sobelShader = this.p.createShader(Q, X), this.sampleShader = this.p.createShader(Q, f(16, this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(Q, z), this.inversionShader = this.p.createShader(Q, R), this.asciiCharacterShader = this.p.createShader(Q, N), this.sobelFramebuffer = this.p.createFramebuffer({
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
  ...
  resetShaders() {
    this.sampleShader = this.p.createShader(Q, f(16, this.grid.cellHeight, this.grid.cellWidth));
  }
  /**
...
const c = (o, A, e, r) => {
  ...
  for (let i = 0; i < Math.max(e.length, r.length); i++) {
    const s = e[i] ?? 0, a = r[i] ?? 0;
    if (s !== a) return s > a ? 1 : -1;
  }
  return 0;
};
class d {
  constructor(A, e, r, i, s, a) {
    t(this, "_brightnessStart");
    t(this, "_brightnessEnd");
    t(this, "enabled");
    t(this, "_onPaletteChangeCallback");
    t(this, "_palette");
    this.p = A, this._fontTextureAtlas = e, this._shader = r, this._characters = i, this._palette = new P(this.p, this._fontTextureAtlas.getCharsetColorArray(this._characters)), this._brightnessStart = Math.floor(s / 255 * 100) / 100, this._brightnessEnd = Math.ceil(a / 255 * 100) / 100, this.enabled = !0;
  }
  /**
   ...
   */
  brightnessStart(A) {
    c(A, 0, 255, "brightness start"), this._brightnessStart = A;
  }
  /**
   ...
   */
  brightnessEnd(A) {
    c(A, 0, 255, "brightness start"), this._brightnessEnd = A;
  }
  /**
...
class j extends d {
  constructor(e, r, i, s, a, E, B) {
    super(e, r, i, s, a, E);
    t(this, "direction");
    t(this, "angle");
    t(this, "speed");
    t(this, "zigzag");
    this.p = e, this._fontTextureAtlas = r, this._shader = i, this._characters = s, this.direction = B.direction, this.angle = B.angle, this.speed = B.speed, this.zigzag = B.zigzag;
  }
  setUniforms(e, r) {
...
class O extends d {
  constructor(e, r, i, s, a, E, B) {
    ...
    t(this, "speed");
    t(this, "density");
    this.p = e, this._fontTextureAtlas = r, this._shader = i, this._characters = s, this.direction = B.direction, this.centerX = B.centerX, this.centerY = B.centerY, this.speed = B.speed, this.density = B.density;
  }
  setUniforms(e, r) {
...
class K extends d {
  constructor(e, r, i, s, a, E, B) {
    ...
    t(this, "centerY");
    t(this, "radius");
    this.p = e, this._fontTextureAtlas = r, this._shader = i, this._characters = s, this.direction = B.direction, this.centerX = B.centerX, this.centerY = B.centerY, this.radius = B.radius;
  }
  setUniforms(e, r) {
...
class W extends d {
  constructor(e, r, i, s, a, E, B) {
    ...
    t(this, "centerY");
    t(this, "speed");
    this.p = e, this._fontTextureAtlas = r, this._shader = i, this._characters = s, this.centerX = B.centerX, this.centerY = B.centerY, this.speed = B.speed;
  }
  setUniforms(e, r) {
...
class q {
  constructor(A, e) {
    ...
    t(this, "_gradientConstructors", {
      linear: (A, e, r, i, s, a, E) => new j(A, e, r, i, s, a, E),
      spiral: (A, e, r, i, s, a, E) => new O(A, e, r, i, s, a, E),
      radial: (A, e, r, i, s, a, E) => new K(A, e, r, i, s, a, E),
      conical: (A, e, r, i, s, a, E) => new W(A, e, r, i, s, a, E)
    });
    t(this, "_gradients", []);
  ...
  add(A, e, r, i, s) {
    ...
    if (c(r, 0, 255, "brightness start"), c(i, 0, 255, "brightness end"), typeof e != "string")
      throw new g("Characters must be a string");
    if (e.length === 0)
      throw new g("Characters string cannot be empty");
    if (!s || typeof s != "object" || Array.isArray(s))
      throw new g("User parameters must be an object");
    const a = Object.keys(this.gradientParams[A]), E = Object.keys(s).filter((x) => !a.includes(x));
    if (E.length > 0)
      throw new g(
...
var AA = "precision mediump float;uniform sampler2D u_image;varying vec2 v_texCoord;void main(){vec4 color=texture2D(u_image,v_texCoord);float luminance=0.299*color.r+0.587*color.g+0.114*color.b;color.rgb=vec3(luminance);gl_FragColor=color;}", eA = "precision mediump float;uniform sampler2D u_sketchTexture;uniform sampler2D u_previousColorTexture;uniform sampler2D u_sampleTexture;uniform sampler2D u_sampleReferenceTexture;uniform vec2 u_gridCellDimensions;uniform int u_sampleMode;uniform vec4 u_staticColor;void main(){vec2 cellCoord=floor(gl_FragCoord.xy);vec2 cellSizeInTexCoords=vec2(1.0)/u_gridCellDimensions;vec2 cellCenterTexCoord=(cellCoord+vec2(0.5))*cellSizeInTexCoords;bool isMatchingSample=texture2D(u_sampleTexture,cellCenterTexCoord)==texture2D(u_sampleReferenceTexture,cellCenterTexCoord);if(isMatchingSample){gl_FragColor=texture2D(u_previousColorTexture,cellCenterTexCoord);return;}else if(u_sampleMode==0){gl_FragColor=texture2D(u_sketchTexture,cellCenterTexCoord);}else{gl_FragColor=u_staticColor;}}", rA = "precision mediump float;uniform sampler2D u_sampleTexture;uniform sampler2D u_sampleReferenceTexture;uniform sampler2D u_previousInversionTexture;uniform vec2 u_gridCellDimensions;uniform bool u_invert;void main(){vec2 cellCoord=floor(gl_FragCoord.xy);vec2 cellSizeInTexCoords=vec2(1.0)/u_gridCellDimensions;vec2 cellCenterTexCoord=(cellCoord+vec2(0.5))*cellSizeInTexCoords;bool isMatchingSample=texture2D(u_sampleTexture,cellCenterTexCoord)==texture2D(u_sampleReferenceTexture,cellCenterTexCoord);if(!isMatchingSample){if(u_invert){gl_FragColor=vec4(1.0);}else{gl_FragColor=vec4(vec3(0.0),1.0);}return;}else{gl_FragColor=texture2D(u_previousInversionTexture,cellCenterTexCoord);}}", tA = "precision mediump float;uniform sampler2D u_prevAsciiCharacterTexture;uniform sampler2D u_prevGradientTexture;uniform sampler2D u_nextGradientTexture;uniform vec2 u_resolution;void main(){vec2 uv=gl_FragCoord.xy/u_resolution;vec4 prevAscii=texture2D(u_prevAsciiCharacterTexture,uv);vec4 prevGradient=texture2D(u_prevGradientTexture,uv);vec4 nextGradient=texture2D(u_nextGradientTexture,uv);bool colorsMatch=prevGradient==nextGradient;gl_FragColor=colorsMatch ? prevAscii : nextGradient;}";
const iA = {
  /** Enable/disable the renderer */
  enabled: !1,
  /** Color of the ASCII characters. Only used when `characterColorMode` is set to `1` */
...
class w extends l {
  constructor(e, r, i, s = iA) {
    ...
    this.gradientManager = new q(this.p, this.fontTextureAtlas), this.grayscaleShader = this.p.createShader(Q, AA), this.colorSampleShader = this.p.createShader(Q, eA), this.inversionShader = this.p.createShader(Q, rA), this.asciiCharacterShader = this.p.createShader(Q, tA), this.grayscaleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
  ...
  add(e, r, i, s, a = {}) {
    return this.gradientManager.add(e, s, r, i, a);
  }
  render(e, r) {
...
class sA {
  constructor(A, e, r) {
    ...
    this.p = A, this.grid = e, this.fontTextureAtlas = r, this.currentCanvasDimensions = {
      ...
      { name: "gradient", renderer: new w(this.p, this.grid, r) },
  ...
  add(A, e, r) {
    ...
    this._renderers.push({
      name: A,
      renderer: new i(this.p, this.grid, this.fontTextureAtlas, r)
    });
  }
  /**
...
class oA {
   ...
   */
  setup() {
    this.asciiFontTextureAtlas = new S(
      this._p,
      this._font,
      this._fontSize
    ), this.grid = new F(
  ...
  loadFont(A) {
    ...
    ) : this._font = A, this._p._setupDone && (this.asciiFontTextureAtlas.setFontObject(A), this.rendererManager.renderers.forEach((e) => e.renderer.characters(e.renderer.options.characters)), this.grid.resizeCellPixelDimensions(
      this.asciiFontTextureAtlas.maxGlyphDimensions.width,
      this.asciiFontTextureAtlas.maxGlyphDimensions.height
    ));
  }
...
h.prototype.registerMethod("init", function() {
  n.instance(this, !1), this._incrementPreload(), n.loadFont(gA);
});
...
export {
  k as ACCURATE_DEFAULT_OPTIONS,
  M as BRIGHTNESS_DEFAULT_OPTIONS,
  y as CUSTOM_DEFAULT_OPTIONS,
  H as EDGE_DEFAULT_OPTIONS,
  iA as GRADIENT_DEFAULT_OPTIONS,
  oA as P5Asciifier,
  I as P5AsciifyAccurateRenderer,
  p as P5AsciifyBrightnessRenderer,
  P as P5AsciifyColorPalette,
  W as P5AsciifyConicalGradient,
  _ as P5AsciifyEdgeRenderer,
  g as P5AsciifyError,
  S as P5AsciifyFontTextureAtlas,
  d as P5AsciifyGradient,
  q as P5AsciifyGradientManager,
  w as P5AsciifyGradientRenderer,
  F as P5AsciifyGrid,
  j as P5AsciifyLinearGradient,
  K as P5AsciifyRadialGradient,
  l as P5AsciifyRenderer,
  sA as P5AsciifyRendererManager,
  O as P5AsciifySpiralGradient,
  J as compareVersions,
  n as p5asciify,
  c as validateNumberInRange
};
