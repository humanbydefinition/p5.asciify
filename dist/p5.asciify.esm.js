...
var S = (t, A, e) => A in t ? b(t, A, { enumerable: !0, configurable: !0, writable: !0, value: e }) : t[A] = e;
var i = (t, A, e) => S(t, typeof A != "symbol" ? A + "" : A, e);
import h from "p5";
...
function y(t) {
  ...
  if (t != null && t.characterColor && !(typeof t.characterColor == "string" || t.characterColor instanceof h.Color || Array.isArray(t.characterColor) && t.characterColor.length === 3 && t.characterColor.every((A) => typeof A == "number")))
    throw new g("`characterColor` must be a string, p5.Color, or array of 3 numbers.");
  if (t != null && t.backgroundColor && !(typeof t.backgroundColor == "string" || t.backgroundColor instanceof h.Color || Array.isArray(t.backgroundColor) && t.backgroundColor.length === 3 && t.backgroundColor.every((A) => typeof A == "number")))
...
class U extends c {
  constructor(e, r, s, o) {
    ...
    this.colorSampleShader = this.p.createShader(Q, G), this.asciiCharacterShader = this.p.createShader(Q, M), this.colorSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class k extends c {
  constructor(e, r, s, o) {
    ...
    this.characterSelectionShader = this.p.createShader(Q, f(this.characterSet.asciiFontTextureAtlas.fontSize)), this.brightnessSampleShader = this.p.createShader(Q, m(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(Q, P(16, this.grid.cellHeight, this.grid.cellWidth)), this.brightnessSplitShader = this.p.createShader(Q, Y), this.brightnessSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
  ...
  resetShaders() {
    this.characterSelectionShader = this.p.createShader(Q, f(this.characterSet.asciiFontTextureAtlas.fontSize)), this.brightnessSampleShader = this.p.createShader(Q, m(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(Q, P(16, this.grid.cellHeight, this.grid.cellWidth));
  }
  render(e, r) {
...
class O extends c {
  constructor(e, r, s, o) {
    ...
    this.sobelShader = this.p.createShader(Q, N), this.sampleShader = this.p.createShader(Q, I(16, this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(Q, z), this.asciiCharacterShader = this.p.createShader(Q, R), this.sobelFramebuffer = this.p.createFramebuffer({
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
  ...
  updateOptions(e) {
    if (super.updateOptions(e), e != null && e.characters && e.characters.length !== p)
      throw new g(`For EdgeAsciiRenderer, 'characters' must be a string of length ${p}.`);
  }
  render(e, r) {
...
class K extends c {
  constructor(e, r, s, o, a) {
    ...
    this.gradientManager = o, this.grayscaleShader = this.p.createShader(Q, X), this.colorSampleShader = this.p.createShader(Q, H), this.asciiCharacterShader = this.p.createShader(Q, J), this.grayscaleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class l {
  ...
  constructor(A, e, r) {
    ...
    i(this, "_characters");
    this.p = A, this.asciiFontTextureAtlas = e, this._characters = this.validateCharacters(r), this.characterColorPalette = new x(this.p, this.asciiFontTextureAtlas.getCharsetColorArray(this._characters));
  }
  /**
...
class D {
  constructor(A, e, r, s, o, a) {
    i(this, "_brightnessStart");
    i(this, "_brightnessEnd");
    i(this, "enabled");
    i(this, "_onPaletteChangeCallback");
    i(this, "_palette");
    this.p = A, this._fontTextureAtlas = e, this._shader = r, this._characters = a, this._palette = new x(this.p, this._fontTextureAtlas.getCharsetColorArray(this._characters)), this._brightnessStart = Math.floor(s / 255 * 100) / 100, this._brightnessEnd = Math.ceil(o / 255 * 100) / 100, this.enabled = !0;
  }
  /**
...
class $ extends D {
  constructor(e, r, s, o, a, E, B) {
    super(e, r, s, o, a, E);
    i(this, "direction");
    i(this, "angle");
    i(this, "speed");
    i(this, "zigzag");
    this.p = e, this._fontTextureAtlas = r, this._shader = s, this.direction = B.direction, this.angle = B.angle, this.speed = B.speed, this.zigzag = B.zigzag;
  }
  setUniforms(e, r) {
...
class q extends D {
  constructor(e, r, s, o, a, E, B) {
    ...
    i(this, "speed");
    i(this, "density");
    this.p = e, this._fontTextureAtlas = r, this._shader = s, this.direction = B.direction, this.centerX = B.centerX, this.centerY = B.centerY, this.speed = B.speed, this.density = B.density;
  }
  setUniforms(e, r) {
...
class AA extends D {
  constructor(e, r, s, o, a, E, B) {
    ...
    i(this, "centerY");
    i(this, "radius");
    this.p = e, this._fontTextureAtlas = r, this._shader = s, this.direction = B.direction, this.centerX = B.centerX, this.centerY = B.centerY, this.radius = B.radius;
  }
  setUniforms(e, r) {
...
class eA extends D {
  constructor(e, r, s, o, a, E, B) {
    ...
    i(this, "centerY");
    i(this, "speed");
    this.p = e, this._fontTextureAtlas = r, this._shader = s, this.centerX = B.centerX, this.centerY = B.centerY, this.speed = B.speed;
  }
  setUniforms(e, r) {
...
class oA {
  constructor(A, e) {
    ...
    i(this, "_gradientConstructors", {
      linear: (A, e, r, s, o, a, E) => new $(A, e, r, s, o, a, E),
      spiral: (A, e, r, s, o, a, E) => new q(A, e, r, s, o, a, E),
      radial: (A, e, r, s, o, a, E) => new AA(A, e, r, s, o, a, E),
      conical: (A, e, r, s, o, a, E) => new eA(A, e, r, s, o, a, E)
    });
    i(this, "_gradients", []);
    ...
    for (const r of Object.keys(this.gradientShaderSources)) {
      ...
      this.gradientShaders[r] = this.p.createShader(Q, s);
    }
  }
  /**
...
class aA {
  constructor(A, e, r) {
    ...
    this.p = A, this.grid = e, this.fontTextureAtlas = r, this.currentCanvasDimensions = {
    ...
    }, this.gradientManager = new oA(A, this.fontTextureAtlas), this.gradientCharacterSet = new l(
      this.p,
      r,
      d.characters
    ), this._renderers = [
      new U(this.p, this.grid, new l(this.p, r, d.characters), { ...d }),
      ...
      new O(this.p, this.grid, new l(this.p, r, w.characters), { ...w }),
      new c(this.p, this.grid, new l(this.p, r, d.characters), { ...L })
...
function gA(t, A, e, r, s, o) {
  ...
  if (u(e, 0, 255, "brightness start"), u(r, 0, 255, "brightness end"), typeof s != "string")
    throw new g("Characters must be a string");
  if (s.length === 0)
    throw new g("Characters string cannot be empty");
  if (!o || typeof o != "object" || Array.isArray(o))
    throw new g("User parameters must be an object");
  const a = Object.keys(t.gradientParams[A]), E = Object.keys(o).filter((B) => !a.includes(B));
  if (E.length > 0)
    throw new g(
