...
class l {
  constructor(A, e, r, i) {
    ...
    this.p = A, this.grid = e, this.characterSet = r, this._options = i, this._options.characterColor && (this._options.characterColor = this.p.color(this._options.characterColor)), this._options.backgroundColor && (this._options.backgroundColor = this.p.color(this._options.backgroundColor)), this._primaryColorSampleFramebuffer = this.p.createFramebuffer({
      ...
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
    }), this._shader = this.p.createShader(a, y);
  }
  /**
...
class M extends l {
  constructor(e, r, i, o) {
    ...
    this.colorSampleShader = this.p.createShader(a, T), this.asciiCharacterShader = this.p.createShader(a, G), this.colorSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class N extends l {
  constructor(e, r, i, o) {
    ...
    this.sobelShader = this.p.createShader(a, R), this.sampleShader = this.p.createShader(a, p(16, this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(a, z), this.asciiCharacterShader = this.p.createShader(a, k), this.sobelFramebuffer = this.p.createFramebuffer({
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
...
class J extends l {
  constructor(e, r, i, o, g) {
    ...
    this.gradientManager = o, this.grayscaleShader = this.p.createShader(a, O), this.colorSampleShader = this.p.createShader(a, X), this.asciiCharacterShader = this.p.createShader(a, H), this.grayscaleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
function EA(s) {
  B.prototype.loadAsciiFont = function(A) {
    ...
    this._incrementPreload(), this.loadAsciiFont(w);
  });
}
function nA(s) {
