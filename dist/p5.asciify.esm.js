...
var v = (s, A, e) => A in s ? S(s, A, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[A] = e;
var t = (s, A, e) => v(s, typeof A != "symbol" ? A + "" : A, e);
import a from "p5";
...
class l {
  constructor(A, e, r) {
    ...
    this.p = A, this.asciiFontTextureAtlas = e, this._characters = this.validateCharacters(r), this.characterColors = this.asciiFontTextureAtlas.getCharsetColorArray(this._characters), this.characterColorPalette = new w(this.characterColors), this.characterColorPalette.setup(this.p);
  }
  /**
...
class E {
   ...
   */
  setup(A, e, r, i) {
    this._p = A, this._fontTextureAtlas = e, this._shader = r, this._palette = new w(i), this._palette.setup(A);
  }
  /**
...
class oA {
  constructor() {
    ...
    t(this, "_gradientConstructors", {
      linear: (A, e, r, i) => new W(A, e, r, i),
      zigzag: (A, e, r, i) => new V(A, e, r, i),
      spiral: (A, e, r, i) => new L(A, e, r, i),
...
class aA {
  ...
  setup(A, e, r) {
    this.p = A, this.grid = e, this.fontTextureAtlas = r, this.currentCanvasDimensions = {
      ...
      new M(this.p, this.grid, new l(this.p, r, d.characters), { ...d }),
      ...
      new c(this.p, this.grid, new l(this.p, r, d.characters), { ...j })
    ];
  }
  /**
...
class gA {
   ...
   */
  setup() {
    this.asciiFontTextureAtlas = new b(this.p, this._font, this._fontSize), this.grid = new F(
      this.p,
...
function QA(s) {
  a.prototype.registerMethod("init", function() {
    s.instance(this);
  }), a.prototype.registerMethod("afterSetup", function() {
    BA(this), s.setup();
  });
}
...
function EA(s) {
  ...
  }, a.prototype.registerPreloadMethod("loadAsciiFont", a.prototype), a.prototype.registerMethod("init", function() {
    this._incrementPreload(), this.loadAsciiFont(x);
  });
}
function nA(s) {
...
function hA(s, A, e, r, i, o) {
  ...
  const B = Object.keys(s.gradientParams[A]), h = Object.keys(o).filter((C) => !B.includes(C));
  if (h.length > 0)
    throw new Q(
