...
var t = (s, A, e) => F(s, typeof A != "symbol" ? A + "" : A, e);
import a from "p5";
...
class y {
  ...
  drawCharacters(A) {
    ...
    for (let e = 0; e < this._characterGlyphs.length; e++) {
      const r = e % this._charsetCols, i = Math.floor(e / this._charsetCols), o = this._maxGlyphDimensions.width * r - this._maxGlyphDimensions.width * this._charsetCols / 2, B = this._maxGlyphDimensions.height * i - this._maxGlyphDimensions.height * this._charsetRows / 2;
...
class G {
  ...
  on(A, e) {
    var r;
    this.eventListeners.has(A) || this.eventListeners.set(A, []), (r = this.eventListeners.get(A)) == null || r.push(e);
  }
  /**
...
class C {
  constructor(A, e, r, i) {
    ...
    this.p = A, this.grid = e, this.characterSet = r, this._options = i, this._primaryColorSampleFramebuffer = this.p.createFramebuffer({
      ...
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
    }), this._shader = this.p.createShader(g, Y);
  }
  /**
...
class k extends C {
  constructor(e, r, i, o) {
    ...
    this.colorSampleShader = this.p.createShader(g, U), this.asciiCharacterShader = this.p.createShader(g, z), this.colorSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class O extends C {
  constructor(e, r, i, o) {
    ...
    this.characterSelectionShader = this.p.createShader(g, p(this.characterSet.asciiFontTextureAtlas.fontSize, this.characterSet.characters.length)), this.brightnessSampleShader = this.p.createShader(g, P(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(g, I(16, this.grid.cellHeight, this.grid.cellWidth)), this.brightnessSplitShader = this.p.createShader(g, R), this.brightnessSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
  ...
  resetShaders() {
    this.characterSelectionShader = this.p.createShader(g, p(this.characterSet.asciiFontTextureAtlas.fontSize)), this.brightnessSampleShader = this.p.createShader(g, P(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(g, I(16, this.grid.cellHeight, this.grid.cellWidth));
  }
  render(e, r) {
...
class J extends C {
  constructor(e, r, i, o) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.sobelShader = this.p.createShader(g, H), this.sampleShader = this.p.createShader(g, _(16, this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(g, N), this.asciiCharacterShader = this.p.createShader(g, X), this.sobelFramebuffer = this.p.createFramebuffer({
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
  ...
  resetShaders() {
    this.sampleShader = this.p.createShader(g, _(16, this.grid.cellHeight, this.grid.cellWidth));
  }
  render(e, r) {
...
class W extends C {
  constructor(e, r, i, o, B) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.gradientManager = o, this.grayscaleShader = this.p.createShader(g, K), this.colorSampleShader = this.p.createShader(g, j), this.asciiCharacterShader = this.p.createShader(g, L), this.grayscaleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class d {
  constructor(A, e, r) {
    ...
    this.p = A, this.asciiFontTextureAtlas = e, this._characters = this.validateCharacters(r), this.characterColors = this.asciiFontTextureAtlas.getCharsetColorArray(this._characters), this.characterColorPalette = new S(this.characterColors), this.characterColorPalette.setup(this.p);
  }
  /**
...
class E {
  ...
  setup(A, e, r, i) {
    this._p = A, this._fontTextureAtlas = e, this._shader = r, this._palette = new S(i), this._palette.setup(A);
  }
  setUniforms(A, e) {
...
class $ extends E {
  constructor(e, r, i, o) {
    ...
    t(this, "_angle");
    t(this, "_speed");
    this._direction = o.direction, this._angle = o.angle, this._speed = o.speed;
  }
  setUniforms(e, r) {
    super.setUniforms(e, r), this._shader.setUniform("u_gradientDirection", this._direction), this._shader.setUniform("u_angle", this._angle * Math.PI / 180), this._shader.setUniform("u_speed", this._speed);
  }
  get direction() {
...
class q extends E {
  constructor(e, r, i, o) {
    ...
    t(this, "_angle");
    t(this, "_speed");
    this._direction = o.direction, this._angle = o.angle, this._speed = o.speed ?? 0.01;
  }
  setUniforms(e, r) {
    super.setUniforms(e, r), this._shader.setUniform("u_gradientDirection", this._direction), this._shader.setUniform("u_angle", this._angle * Math.PI / 180), this._shader.setUniform("u_speed", this._speed);
  }
...
class AA extends E {
  constructor(e, r, i, o) {
    ...
    t(this, "_speed");
    t(this, "_density");
    this._direction = o.direction, this._centerX = o.centerX, this._centerY = o.centerY, this._speed = o.speed, this._density = o.density;
  }
  setUniforms(e, r) {
    super.setUniforms(e, r), this._shader.setUniform("u_gradientDirection", this._direction), this._shader.setUniform("u_centerX", this._centerX), this._shader.setUniform("u_centerY", this._centerY), this._shader.setUniform("u_speed", this._speed), this._shader.setUniform("u_density", this._density);
  }
  get direction() {
    return this._direction;
  }
...
class eA extends E {
  constructor(e, r, i, o) {
    ...
    t(this, "_centerY");
    t(this, "_radius");
    this._direction = o.direction, this._centerX = o.centerX, this._centerY = o.centerY, this._radius = o.radius;
  }
  setUniforms(e, r) {
    super.setUniforms(e, r), this._shader.setUniform("u_gradientDirection", this._direction), this._shader.setUniform("u_centerX", this._centerX), this._shader.setUniform("u_centerY", this._centerY), this._shader.setUniform("u_radius", this._radius);
  }
  get direction() {
    return this._direction;
  }
...
class rA extends E {
  constructor(e, r, i, o) {
    ...
    t(this, "_centerY");
    t(this, "_speed");
    this._centerX = o.centerX, this._centerY = o.centerY, this._speed = o.speed;
  }
  setUniforms(e, r) {
    super.setUniforms(e, r), this._shader.setUniform("u_centerX", this._centerX), this._shader.setUniform("u_centerY", this._centerY), this._shader.setUniform("u_speed", this._speed);
  }
  get centerX() {
    return this._centerX;
  }
...
class tA extends E {
  constructor(e, r, i, o) {
    ...
    t(this, "_noiseScale");
    t(this, "_speed");
    this._direction = o.direction, this._noiseScale = o.noiseScale, this._speed = o.speed;
  }
  setUniforms(e, r) {
    super.setUniforms(e, r), this._shader.setUniform("direction", this._direction), this._shader.setUniform("noiseScale", this._noiseScale), this._shader.setUniform("u_speed", this._speed);
  }
  get direction() {
    return this._direction;
  }
...
class QA {
  constructor() {
    ...
    t(this, "_gradientConstructors", {
      linear: (A, e, r, i) => new $(A, e, r, i),
      zigzag: (A, e, r, i) => new q(A, e, r, i),
      spiral: (A, e, r, i) => new AA(A, e, r, i),
      radial: (A, e, r, i) => new eA(A, e, r, i),
      conical: (A, e, r, i) => new rA(A, e, r, i),
      noise: (A, e, r, i) => new tA(A, e, r, i)
    });
    t(this, "_setupQueue", []);
    t(this, "_gradients", []);
  ...
  addGradient(A, e, r, i, o) {
    ...
    return this._gradients.push(B), this.p5Instance._setupDone ? B.setup(
      this.p5Instance,
      this.fontTextureAtlas,
  ...
  setupShaders() {
    for (const A of Object.keys(this.gradientShaderSources)) {
      ...
      this.gradientShaders[A] = this.p5Instance.createShader(g, e);
    }
  }
...
class nA {
  ...
  setup(A, e, r) {
    ...
    }, this.gradientCharacterSet = new d(
      this.p,
      r,
      D.characters
    ), this.gradientManager.setup(this.fontTextureAtlas), this._renderers = [
      new k(this.p, this.grid, new d(this.p, r, D.characters), { ...D }),
      new O(this.p, this.grid, new d(this.p, r, w.characters), { ...w }),
      new W(this.p, this.grid, this.gradientCharacterSet, this.gradientManager, { ...V }),
      new J(this.p, this.grid, new d(this.p, r, x.characters), { ...x }),
      new C(this.p, this.grid, new d(this.p, r, D.characters), { ...Z })
    ];
  }
  /**
...
function hA(s) {
  ...
  function A(e, r) {
    const [i, o] = [e, r].map((B) => B.split(".").map(Number));
    for (let B = 0; B < Math.max(i.length, o.length); B++) {
      const l = i[B] ?? 0, c = o[B] ?? 0;
...
function lA(s) {
  a.prototype.setupP5Instance = function() {
    s.addP5Instance(this);
  }, a.prototype.setupAsciifier = function() {
    hA(this), s.setup();
  }, a.prototype.registerMethod("init", a.prototype.setupP5Instance), a.prototype.registerMethod("afterSetup", a.prototype.setupAsciifier);
}
...
`;
function dA(s) {
  a.prototype.preloadAsciiFont = function() {
    this._incrementPreload(), this.loadAsciiFont(cA);
  }, a.prototype.loadAsciiFont = function(A) {
    const e = (r) => {
      s.font = r, this._decrementPreload(), s.eventEmitter.emit("fontUpdated", {});
    };
    if (typeof A == "string")
      this.loadFont(
        A,
    ...
    else if (A instanceof a.Font)
      e(A);
    else
      throw new Q("loadAsciiFont() | Invalid font parameter. Expected a path, base64 string, or p5.Font object.");
  }, a.prototype.registerMethod("beforePreload", a.prototype.preloadAsciiFont), a.prototype.registerPreloadMethod("loadAsciiFont", a.prototype);
}
function CA(s) {
  a.prototype.setAsciifyBorderColor = function(A) {
    s.borderColor = A;
  }, a.prototype.setAsciifyFontSize = function(A) {
    s.fontSize = A;
  }, a.prototype.setAsciifyPostSetupFunction = function(A) {
    s.postSetupFunction = A;
  }, a.prototype.setAsciifyPostDrawFunction = function(A) {
    s.postDrawFunction = A;
  };
}
function uA(s, A, e, r, i, o) {
  ...
  if (B(e, 0, 255, "brightness start"), B(r, 0, 255, "brightness end"), typeof i != "string")
    throw new Q(
...
function DA(s) {
  a.prototype.addAsciiGradient = function(A, e, r, i, o = {}) {
    return uA(
  ...
  }, a.prototype.removeAsciiGradient = function(A) {
    s.rendererManager.gradientManager.removeGradient(A);
  };
}
function fA(s) {
  a.prototype.preAsciifyDraw = function() {
    s.sketchFramebuffer.begin(), this.clear(), this.push();
  }, a.prototype.postAsciifyDraw = function() {
    this.pop(), s.sketchFramebuffer.end(), s.asciify();
  }, a.prototype.registerMethod("pre", a.prototype.preAsciifyDraw), a.prototype.registerMethod("post", a.prototype.postAsciifyDraw);
}
const h = new EA();
