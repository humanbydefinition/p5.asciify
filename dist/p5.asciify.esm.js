...
var v = (t, A, e) => A in t ? S(t, A, { enumerable: !0, configurable: !0, writable: !0, value: e }) : t[A] = e;
...
class c {
  constructor(A, e, r, s) {
    ...
    this.p = A, this.grid = e, this.characterSet = r, this._options = s, this._options.characterColor && (this._options.characterColor = this.p.color(this._options.characterColor)), this._options.backgroundColor && (this._options.backgroundColor = this.p.color(this._options.backgroundColor)), this._primaryColorSampleFramebuffer = this.p.createFramebuffer({
      ...
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
    }), this._shader = this.p.createShader(h, G);
  }
  /**
...
class Y extends c {
  constructor(e, r, s, o) {
    ...
    this.colorSampleShader = this.p.createShader(h, M), this.asciiCharacterShader = this.p.createShader(h, U), this.colorSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class k extends c {
  constructor(e, r, s, o) {
    ...
    this.characterSelectionShader = this.p.createShader(h, m(this.characterSet.asciiFontTextureAtlas.fontSize)), this.brightnessSampleShader = this.p.createShader(h, P(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(h, I(16, this.grid.cellHeight, this.grid.cellWidth)), this.brightnessSplitShader = this.p.createShader(h, z), this.brightnessSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class J extends c {
  constructor(e, r, s, o) {
    ...
    this.sobelShader = this.p.createShader(h, O), this.sampleShader = this.p.createShader(h, p(16, this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(h, R), this.asciiCharacterShader = this.p.createShader(h, N), this.sobelFramebuffer = this.p.createFramebuffer({
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
...
class V extends c {
  constructor(e, r, s, o, a) {
    ...
    this.gradientManager = o, this.grayscaleShader = this.p.createShader(h, j), this.colorSampleShader = this.p.createShader(h, K), this.asciiCharacterShader = this.p.createShader(h, W), this.grayscaleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class aA {
  constructor(A, e) {
    ...
    i(this, "_gradientConstructors", {
      linear: (A, e, r, s, o, a, B, E) => new Z(A, e, r, s, o, a, B, E),
      spiral: (A, e, r, s, o, a, B, E) => new $(A, e, r, s, o, a, B, E),
      radial: (A, e, r, s, o, a, B, E) => new q(A, e, r, s, o, a, B, E),
      conical: (A, e, r, s, o, a, B, E) => new AA(A, e, r, s, o, a, B, E),
      noise: (A, e, r, s, o, a, B, E) => new eA(A, e, r, s, o, a, B, E)
    });
    i(this, "_gradients", []);
...
class gA {
  constructor(A, e, r) {
    ...
    this.p = A, this.grid = e, this.fontTextureAtlas = r, this.currentCanvasDimensions = {
    ...
    }, this.gradientManager = new aA(A, this.fontTextureAtlas), this.gradientCharacterSet = new l(
      this.p,
      r,
      d.characters
    ), this._renderers = [
      new Y(this.p, this.grid, new l(this.p, r, d.characters), { ...d }),
      new k(this.p, this.grid, new l(this.p, r, _.characters), { ..._ }),
      ...
      new c(this.p, this.grid, new l(this.p, r, d.characters), { ...H })
...
function BA(t, A, e, r, s, o) {
  ...
  if (D(e, 0, 255, "brightness start"), D(r, 0, 255, "brightness end"), typeof s != "string")
    throw new g("Characters must be a string");
  if (s.length === 0)
...
class QA {
  ...
  setup() {
    ...
    ), this.rendererManager = new gA(this.p, this.grid, this.asciiFontTextureAtlas), this.sketchFramebuffer = this.p.createFramebuffer({
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
    });
  }
