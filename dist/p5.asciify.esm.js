...
class O extends c {
  constructor(e, r, i, o) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.sobelShader = this.p.createShader(g, N), this.sampleShader = this.p.createShader(g, P(16, this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(g, k), this.asciiCharacterShader = this.p.createShader(g, R), this.sobelFramebuffer = this.p.createFramebuffer({
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
...
class gA {
  ...
  setup(A, e, r) {
    this.p = A, this.grid = e, this.fontTextureAtlas = r, this.currentCanvasDimensions = {
      ...
      new O(this.p, this.grid, new l(this.p, r, _.characters), { ..._ }),
...
class BA {
  constructor() {
    ...
    this.borderColor = "#000000", this._fontSize = 16, this.rendererManager = new gA(), this.eventEmitter = new y(), this.postSetupFunction = null, this.postDrawFunction = null;
  }
  /**
