...
class nA {
  ...
  setup(A, e, t) {
    this.p = A, this.grid = e, this.fontTextureAtlas = t, this.currentCanvasDimensions = {
      ...
      new k(this.p, this.grid, new d(this.p, t, D.characters), { ...D }),
      new O(this.p, this.grid, new d(this.p, t, w.characters), { ...w }),
      new W(this.p, this.grid, this.gradientCharacterSet, this.gradientManager, { ...V }),
      new J(this.p, this.grid, new d(this.p, t, x.characters), { ...x }),
      new C(this.p, this.grid, new d(this.p, t, D.characters), { ...Z })
    ];
  }
  /**
