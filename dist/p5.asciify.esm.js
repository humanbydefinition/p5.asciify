...
var S = (s, A, e) => A in s ? x(s, A, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[A] = e;
...
function y(s, A) {
  if (A != null && A.characterColor && (A.characterColor = s.color(A.characterColor)), A != null && A.backgroundColor && (A.backgroundColor = s.color(A.backgroundColor)), A != null && A.fontSize && (A.fontSize < C.MIN || A.fontSize > C.MAX))
    throw new Q(`Font size ${A.fontSize} is out of bounds. It should be between ${C.MIN} and ${C.MAX}.`);
}
...
class U extends c {
  constructor(e, r, i, o) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.colorSampleShader = this.p.createShader(g, G), this.asciiCharacterShader = this.p.createShader(g, M), this.colorSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class N extends c {
  constructor(e, r, i, o) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.sobelShader = this.p.createShader(g, O), this.sampleShader = this.p.createShader(g, P(16, this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(g, k), this.asciiCharacterShader = this.p.createShader(g, R), this.sobelFramebuffer = this.p.createFramebuffer({
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
...
class K extends c {
  constructor(e, r, i, o, B) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.gradientManager = o, this.grayscaleShader = this.p.createShader(g, X), this.colorSampleShader = this.p.createShader(g, H), this.asciiCharacterShader = this.p.createShader(g, J), this.grayscaleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class aA {
  constructor() {
    ...
    t(this, "_gradientConstructors", {
      ...
      spiral: (A, e, r, i) => new Z(A, e, r, i),
      radial: (A, e, r, i) => new $(A, e, r, i),
      conical: (A, e, r, i) => new q(A, e, r, i),
      noise: (A, e, r, i) => new AA(A, e, r, i)
    });
    t(this, "_setupQueue", []);
    t(this, "_gradients", []);
...
class gA {
  ...
  setup(A, e, r) {
    this.p = A, this.grid = e, this.fontTextureAtlas = r, this.currentCanvasDimensions = {
      ...
      new U(this.p, this.grid, new l(this.p, r, u.characters), { ...u }),
      new z(this.p, this.grid, new l(this.p, r, I.characters), { ...I }),
      ...
      new c(this.p, this.grid, new l(this.p, r, u.characters), { ...L })
    ];
  }
  /**
...
class BA {
  constructor() {
    ...
    this.borderColor = "#000000", this._fontSize = 16, this.rendererManager = new gA(), this.eventEmitter = new F(), this.postSetupFunction = null, this.postDrawFunction = null;
  }
  /**
...
function hA(s) {
  a.prototype.preloadAsciiFont = function() {
    this._incrementPreload(), this.loadAsciiFont(nA);
