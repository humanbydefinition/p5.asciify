...
var t = (o, A, e) => R(o, typeof A != "symbol" ? A + "" : A, e);
import n from "p5";
...
class l {
  constructor(A, e, r, i = C) {
    ...
    t(this, "_shader");
    this.p = A, this.grid = e, this.fontTextureAtlas = r, this._options = i, this._options = { ...C, ...i }, this.characterColorPalette = new F(this.p, this.fontTextureAtlas.getCharsetColorArray(this._options.characters)), this._primaryColorSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      antialias: !1,
...
class c {
  constructor(A, e, r, i, s, a) {
    ...
    t(this, "_palette");
    this.p = A, this._fontTextureAtlas = e, this._shader = r, this._characters = i, this._palette = new F(this.p, this._fontTextureAtlas.getCharsetColorArray(this._characters)), this._brightnessStart = Math.floor(s / 255 * 100) / 100, this._brightnessEnd = Math.ceil(a / 255 * 100) / 100, this.enabled = !0;
  }
  /**
...
class M {
  constructor(A, e) {
    ...
    t(this, "_gradientConstructors", {
      linear: (A, e, r, i, s, a, E) => new T(A, e, r, i, s, a, E),
      spiral: (A, e, r, i, s, a, E) => new y(A, e, r, i, s, a, E),
      radial: (A, e, r, i, s, a, E) => new G(A, e, r, i, s, a, E),
      conical: (A, e, r, i, s, a, E) => new U(A, e, r, i, s, a, E)
    });
    t(this, "_gradients", []);
  ...
  add(A, e, r, i, s) {
    ...
    if (d(r, 0, 255, "brightness start"), d(i, 0, 255, "brightness end"), typeof e != "string")
      throw new g("Characters must be a string");
    if (e.length === 0)
...
class Y {
  constructor(A, e, r) {
    ...
    this.p = A, this.grid = e, this.fontTextureAtlas = r, this.currentCanvasDimensions = {
      ...
      { name: "accurate", renderer: new p(this.p, this.grid, r) },
      { name: "gradient", renderer: new _(this.p, this.grid, r) },
      { name: "edge", renderer: new I(this.p, this.grid, r) },
  ...
  add(A, e, r) {
    ...
    const s = new i(this.p, this.grid, this.fontTextureAtlas, r);
...
class oA {
   ...
   */
  setup() {
    this.asciiFontTextureAtlas = new N(
      this._p,
      this._font,
      this._fontSize
    ), this.grid = new X(
   ...
   */
  asciify() {
    this._p.clear(), this.rendererManager.renderers.length > 0 ? (this.rendererManager.render(this.sketchFramebuffer), this._p.background(this._backgroundColor), this._p.image(this.rendererManager.lastRenderer.outputFramebuffer, -this._p.width / 2, -this._p.height / 2)) : this._p.image(this.sketchFramebuffer, -this._p.width / 2, -this._p.height / 2);
  }
  /**
