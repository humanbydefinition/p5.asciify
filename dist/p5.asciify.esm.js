...
class N {
  ...
  constructor(A, e, r = 16) {
    ...
    i(this, "_charsetRows");
    this._p = A, this._font = e, this._fontSize = r;
    const t = Object.values(this._font.font.glyphs.glyphs);
  ...
  _loadCharacterGlyphs() {
    return Object.values(this._font.font.glyphs.glyphs).filter((A) => A.unicode !== void 0).map((A, e) => (A.r = e % 256, A.g = Math.floor(e / 256) % 256, A.b = Math.floor(e / 65536), A));
  }
  /**
   ...
   */
  setFontObject(A) {
    this._font = A, this._characters = Object.values(this._font.font.glyphs.glyphs).filter((e) => e.unicode !== void 0).map((e) => String.fromCharCode(e.unicode)), this._characterGlyphs = this._loadCharacterGlyphs(), this._maxGlyphDimensions = this._getMaxGlyphDimensions(this._fontSize), this._createTexture(this._fontSize);
  }
  /**
   ...
   */
  _createTexture(A) {
    this._charsetCols = Math.ceil(Math.sqrt(this._characters.length)), this._charsetRows = Math.ceil(this._characters.length / this._charsetCols), this._texture ? this._texture.resize(this._maxGlyphDimensions.width * this._charsetCols, this._maxGlyphDimensions.height * this._charsetRows) : this._texture = this._p.createFramebuffer({
   ...
   */
  _drawCharacters(A) {
    this._p.clear(), this._p.textFont(this._font), this._p.fill(255), this._p.textSize(A), this._p.textAlign(this._p.LEFT, this._p.TOP), this._p.noStroke();
    for (let e = 0; e < this._characterGlyphs.length; e++) {
      ...
      this._p.text(String.fromCharCode(this._characterGlyphs[e].unicode), s, a);
    }
  }
  /**
...
class l {
  constructor(A, e, r, t = u) {
    ...
    i(this, "_shader");
    this._p = A, this._grid = e, this._fontTextureAtlas = r, this._options = t, this._options = { ...u, ...t }, this._characterColorPalette = new F(this._p, this._fontTextureAtlas.getCharsetColorArray(this._options.characters)), this._primaryColorFramebuffer = this._p.createFramebuffer({
      density: 1,
      antialias: !1,
      ...
      depthFormat: this._p.UNSIGNED_INT,
      textureFiltering: this._p.NEAREST
    }), this._shader = this._p.createShader(Q, H), this.update(this._options);
  }
  /**
   * Resizes all framebuffers based on the grid dimensions.
   */
  resizeFramebuffers() {
    this._primaryColorFramebuffer.resize(this._grid.cols, this._grid.rows), this._secondaryColorFramebuffer.resize(this._grid.cols, this._grid.rows), this._inversionFramebuffer.resize(this._grid.cols, this._grid.rows), this._characterFramebuffer.resize(this._grid.cols, this._grid.rows);
  }
  /**
  ...
  characters(A = "") {
    ...
    this._fontTextureAtlas.validateCharacters(A), this._characterColorPalette.setColors(this._fontTextureAtlas.getCharsetColorArray(A)), this.resetShaders(), this._options.characters = A;
  }
  /**
...
class m extends l {
  constructor(e, r, t, s = C) {
    ...
    this.colorSampleShader = this._p.createShader(Q, J), this.asciiCharacterShader = this._p.createShader(Q, O), this.colorSampleFramebuffer = this._p.createFramebuffer({
      density: 1,
      width: this._grid.cols,
      height: this._grid.rows,
      depthFormat: this._p.UNSIGNED_INT,
...
class P extends l {
  constructor(e, r, t, s = _) {
    ...
    this._characterSelectionShader = this._p.createShader(Q, w(this._fontTextureAtlas.fontSize)), this._brightnessSampleShader = this._p.createShader(Q, x(this._grid.cellHeight, this._grid.cellWidth)), this._colorSampleShader = this._p.createShader(Q, b(16, this._grid.cellHeight, this._grid.cellWidth)), this._brightnessSplitShader = this._p.createShader(Q, j), this._brightnessSampleFramebuffer = this._p.createFramebuffer({
      density: 1,
      width: this._grid.cols,
      height: this._grid.rows,
      depthFormat: this._p.UNSIGNED_INT,
...
class I extends l {
  constructor(e, r, t, s = f) {
    ...
    this.sobelShader = this._p.createShader(Q, V), this.sampleShader = this._p.createShader(Q, v(16, this._grid.cellHeight, this._grid.cellWidth)), this.colorSampleShader = this._p.createShader(Q, K), this.inversionShader = this._p.createShader(Q, W), this.asciiCharacterShader = this._p.createShader(Q, L), this.sobelFramebuffer = this._p.createFramebuffer({
      depthFormat: this._p.UNSIGNED_INT,
      textureFiltering: this._p.NEAREST
  ...
  resetShaders() {
    this.sampleShader = this._p.createShader(Q, v(16, this._grid.cellHeight, this._grid.cellWidth));
  }
  /**
...
class c {
  constructor(A, e, r, t, s, a) {
    ...
    i(this, "_palette");
    this.p = A, this._fontTextureAtlas = e, this._shader = r, this._characters = t, this._palette = new F(
      this.p,
      this._fontTextureAtlas.getCharsetColorArray(this._characters)
    ), this._brightnessStart = Math.floor(s / 255 * 100) / 100, this._brightnessEnd = Math.ceil(a / 255 * 100) / 100, this._enabled = !0;
  }
  /**
...
class p extends l {
  constructor(e, r, t, s = D) {
    ...
    this.gradientManager = new M(this._p, this._fontTextureAtlas), this.grayscaleShader = this._p.createShader(Q, rA), this.colorSampleShader = this._p.createShader(Q, tA), this.inversionShader = this._p.createShader(Q, iA), this.asciiCharacterShader = this._p.createShader(Q, sA), this.grayscaleFramebuffer = this._p.createFramebuffer({
      density: 1,
      width: this._grid.cols,
      height: this._grid.rows,
      depthFormat: this._p.UNSIGNED_INT,
...
class Y {
  constructor(A, e, r) {
    ...
    this._p = A, this._grid = e, this._fontTextureAtlas = r, this._currentCanvasDimensions = {
      ...
      { name: "custom", renderer: new l(this._p, this._grid, r) },
      { name: "edge", renderer: new I(this._p, this._grid, r) },
      { name: "gradient", renderer: new p(this._p, this._grid, r) },
      { name: "accurate", renderer: new P(this._p, this._grid, r) },
      { name: "brightness", renderer: new m(this._p, this._grid, r) }
...
`, QA = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  CUSTOM_DEFAULT_OPTIONS: u,
  EDGE_DEFAULT_OPTIONS: f,
  GRADIENT_DEFAULT_OPTIONS: D,
  P5AsciifyAccurateRenderer: P,
  P5AsciifyBrightnessRenderer: m,
  P5AsciifyEdgeRenderer: I,
