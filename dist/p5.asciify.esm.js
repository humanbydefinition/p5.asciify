...
class l {
  constructor(A, e, r, i = x) {
    ...
    this.p = A, this.grid = e, this.fontTextureAtlas = r, this._options = i, this._options.characterColor && (this._options.characterColor = this.p.color(this._options.characterColor)), this._options.backgroundColor && (this._options.backgroundColor = this.p.color(this._options.backgroundColor)), this.characterColorPalette = new w(this.p, this.fontTextureAtlas.getCharsetColorArray(this._options.characters)), this._primaryColorSampleFramebuffer = this.p.createFramebuffer({
      ...
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
    }), this._shader = this.p.createShader(Q, H);
  }
  /**
...
class C extends l {
  constructor(e, r, i, s = b) {
    super(e, r, i, s);
    t(this, "colorSampleShader");
    t(this, "asciiCharacterShader");
    t(this, "colorSampleFramebuffer");
    this.colorSampleShader = this.p.createShader(Q, J), this.asciiCharacterShader = this.p.createShader(Q, j), this.colorSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class u extends l {
  constructor(e, r, i, s = v) {
    ...
    this.characterSelectionShader = this.p.createShader(Q, m(this.fontTextureAtlas.fontSize)), this.brightnessSampleShader = this.p.createShader(Q, P(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(Q, p(16, this.grid.cellHeight, this.grid.cellWidth)), this.brightnessSplitShader = this.p.createShader(Q, O), this.brightnessSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
  ...
  resetShaders() {
    this.characterSelectionShader = this.p.createShader(Q, m(this.fontTextureAtlas.fontSize)), this.brightnessSampleShader = this.p.createShader(Q, P(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(Q, p(16, this.grid.cellHeight, this.grid.cellWidth));
  }
  render(e, r) {
...
class D extends l {
  constructor(e, r, i, s = S) {
    ...
    this.sobelShader = this.p.createShader(Q, V), this.sampleShader = this.p.createShader(Q, I(16, this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(Q, K), this.inversionShader = this.p.createShader(Q, W), this.asciiCharacterShader = this.p.createShader(Q, L), this.sobelFramebuffer = this.p.createFramebuffer({
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
  ...
  resetShaders() {
    this.sampleShader = this.p.createShader(Q, I(16, this.grid.cellHeight, this.grid.cellWidth));
  }
  /**
...
class c {
  constructor(A, e, r, i, s, a) {
    ...
    t(this, "_palette");
    this.p = A, this._fontTextureAtlas = e, this._shader = r, this._characters = i, this._palette = new w(this.p, this._fontTextureAtlas.getCharsetColorArray(this._characters)), this._brightnessStart = Math.floor(s / 255 * 100) / 100, this._brightnessEnd = Math.ceil(a / 255 * 100) / 100, this.enabled = !0;
  }
  /**
...
class U {
  constructor(A, e) {
    ...
    t(this, "_gradientConstructors", {
      linear: (A, e, r, i, s, a, E) => new F(A, e, r, i, s, a, E),
      spiral: (A, e, r, i, s, a, E) => new T(A, e, r, i, s, a, E),
      radial: (A, e, r, i, s, a, E) => new y(A, e, r, i, s, a, E),
      conical: (A, e, r, i, s, a, E) => new G(A, e, r, i, s, a, E)
    });
    t(this, "_gradients", []);
...
class f extends l {
  constructor(e, r, i, s = M) {
    ...
    this.gradientManager = new U(this.p, this.fontTextureAtlas), this.grayscaleShader = this.p.createShader(Q, rA), this.colorSampleShader = this.p.createShader(Q, tA), this.inversionShader = this.p.createShader(Q, iA), this.asciiCharacterShader = this.p.createShader(Q, sA), this.grayscaleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class Y {
  constructor(A, e, r) {
    ...
    this.p = A, this.grid = e, this.fontTextureAtlas = r, this.currentCanvasDimensions = {
      ...
      { name: "brightness", renderer: new C(this.p, this.grid, r) },
      { name: "accurate", renderer: new u(this.p, this.grid, r) },
      { name: "gradient", renderer: new f(this.p, this.grid, r) },
      { name: "edge", renderer: new D(this.p, this.grid, r) },
  ...
  add(A, e, r) {
    ...
    if (!i)
      throw new g(
        `Invalid renderer type: ${e}. Valid types are: ${Object.keys(_).join(", ")}`
      );
...
`, QA = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  ACCURATE_DEFAULT_OPTIONS: v,
  BRIGHTNESS_DEFAULT_OPTIONS: b,
  CUSTOM_DEFAULT_OPTIONS: x,
  EDGE_DEFAULT_OPTIONS: S,
  GRADIENT_DEFAULT_OPTIONS: M,
  P5AsciifyAccurateRenderer: u,
  P5AsciifyBrightnessRenderer: C,
  P5AsciifyEdgeRenderer: D,
  P5AsciifyGradientRenderer: f,
  P5AsciifyRenderer: l,
  P5AsciifyRendererManager: Y
}, Symbol.toStringTag, { value: "Module" })), EA = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  P5AsciifyConicalGradient: G,
  P5AsciifyGradient: c,
  P5AsciifyGradientManager: U,
  P5AsciifyLinearGradient: F,
  P5AsciifyRadialGradient: y,
  P5AsciifySpiralGradient: T
