...
function M(s, A) {
  if (A != null && A.characterColor && (A.characterColor = s.color(A.characterColor)), A != null && A.backgroundColor && (A.backgroundColor = s.color(A.backgroundColor)), A != null && A.fontSize && (A.fontSize < f.MIN || A.fontSize > f.MAX))
    throw new B(`Font size ${A.fontSize} is out of bounds. It should be between ${f.MIN} and ${f.MAX}.`);
}
class Q {
  constructor(A, e, t, i) {
...
class k extends Q {
  constructor(e, t, i, o) {
    ...
    this.colorSampleShader = this.p.createShader(n, Y), this.asciiCharacterShader = this.p.createShader(n, z), this.shader = this.p.createShader(n, C), this.colorSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class O extends Q {
  constructor(e, t, i, o) {
    ...
    this.characterSelectionShader = this.p.createShader(n, _(this.characterSet.asciiFontTextureAtlas.fontSize, this.characterSet.characters.length)), this.brightnessSampleShader = this.p.createShader(n, P(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(n, I(16, this.grid.cellHeight, this.grid.cellWidth)), this.brightnessSplitShader = this.p.createShader(n, R), this.shader = this.p.createShader(n, C), this.brightnessSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
  ...
  resetShaders() {
    this.characterSelectionShader = this.p.createShader(n, _(this.characterSet.asciiFontTextureAtlas.fontSize)), this.brightnessSampleShader = this.p.createShader(n, P(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(n, I(16, this.grid.cellHeight, this.grid.cellWidth));
  }
  render(e, t) {
...
class K extends Q {
  constructor(e, t, i, o) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.sobelShader = this.p.createShader(n, J), this.sampleShader = this.p.createShader(n, x(16, this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(n, X), this.asciiCharacterShader = this.p.createShader(n, H), this.shader = this.p.createShader(n, C), this.sobelFramebuffer = this.p.createFramebuffer({
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
...
class V extends Q {
  constructor(e, t, i, o, a) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.gradientManager = o, this.grayscaleShader = this.p.createShader(n, j), this.colorSampleShader = this.p.createShader(n, L), this.asciiCharacterShader = this.p.createShader(n, W), this.asciiShader = this.p.createShader(n, C), this.grayscaleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class QA {
  ...
  setup(A, e, t) {
    this.p = A, this.grid = e, this.fontTextureAtlas = t, this.currentCanvasDimensions = {
      ...
      new k(this.p, this.grid, new u(this.p, t, D.characters), { ...D }),
      new O(this.p, this.grid, new u(this.p, t, w.characters), { ...w }),
      new V(this.p, this.grid, this.gradientCharacterSet, this.gradientManager, { ...Z }),
      new K(this.p, this.grid, new u(this.p, t, S.characters), { ...S }),
      new N(this.p, this.grid, new u(this.p, t, D.characters), { ...$ })
    ];
  }
  /**
...
class EA {
  constructor() {
    ...
    this.borderColor = "#000000", this._fontSize = 16, this.rendererManager = new QA(), this.eventEmitter = new G(), this.postSetupFunction = null, this.postDrawFunction = null;
  }
  /**
  ...
  g.prototype.preloadAsciiFont = function() {
    ...
    if (typeof A == "string")
      this.loadFont(
        ...
        () => {
          throw new B(`loadAsciiFont() | Failed to load font from path: '${A}'`);
        }
      );
    else if (A instanceof g.Font)
      e(A);
    else
      throw new B("loadAsciiFont() | Invalid font parameter. Expected a path, base64 string, or p5.Font object.");
