...
class M extends c {
  constructor(e, r, i, o) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.colorSampleShader = this.p.createShader(g, T), this.asciiCharacterShader = this.p.createShader(g, G), this.colorSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class Y extends c {
  constructor(e, r, i, o) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.characterSelectionShader = this.p.createShader(g, f(this.characterSet.asciiFontTextureAtlas.fontSize, this.characterSet.characters.length)), this.brightnessSampleShader = this.p.createShader(g, m(this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(g, p(16, this.grid.cellHeight, this.grid.cellWidth)), this.brightnessSplitShader = this.p.createShader(g, U), this.brightnessSampleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class N extends c {
  constructor(e, r, i, o) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.sobelShader = this.p.createShader(g, R), this.sampleShader = this.p.createShader(g, P(16, this.grid.cellHeight, this.grid.cellWidth)), this.colorSampleShader = this.p.createShader(g, z), this.asciiCharacterShader = this.p.createShader(g, k), this.sobelFramebuffer = this.p.createFramebuffer({
      depthFormat: this.p.UNSIGNED_INT,
      textureFiltering: this.p.NEAREST
  ...
  resetShaders() {
    this.sampleShader = this.p.createShader(g, P(16, this.grid.cellHeight, this.grid.cellWidth));
  }
  render(e, r) {
...
class J extends c {
  constructor(e, r, i, o, B) {
    ...
    this._options.characterColor = this.p.color(this._options.characterColor), this._options.backgroundColor = this.p.color(this._options.backgroundColor), this.gradientManager = o, this.grayscaleShader = this.p.createShader(g, O), this.colorSampleShader = this.p.createShader(g, X), this.asciiCharacterShader = this.p.createShader(g, H), this.grayscaleFramebuffer = this.p.createFramebuffer({
      density: 1,
      width: this.grid.cols,
      height: this.grid.rows,
      depthFormat: this.p.UNSIGNED_INT,
...
class oA {
  constructor() {
    ...
    t(this, "_gradientConstructors", {
      linear: (A, e, r, i) => new L(A, e, r, i),
      zigzag: (A, e, r, i) => new W(A, e, r, i),
      spiral: (A, e, r, i) => new V(A, e, r, i),
      radial: (A, e, r, i) => new Z(A, e, r, i),
      conical: (A, e, r, i) => new $(A, e, r, i),
      noise: (A, e, r, i) => new q(A, e, r, i)
    });
    t(this, "_setupQueue", []);
    t(this, "_gradients", []);
...
class aA {
  ...
  setup(A, e, r) {
    this.p = A, this.grid = e, this.fontTextureAtlas = r, this.currentCanvasDimensions = {
      ...
      new M(this.p, this.grid, new l(this.p, r, C.characters), { ...C }),
      new Y(this.p, this.grid, new l(this.p, r, I.characters), { ...I }),
      new J(this.p, this.grid, this.gradientCharacterSet, this.gradientManager, { ...K }),
      new N(this.p, this.grid, new l(this.p, r, _.characters), { ..._ }),
      new c(this.p, this.grid, new l(this.p, r, C.characters), { ...j })
    ];
  }
  /**
...
class gA {
  constructor() {
    ...
    this.borderColor = "#000000", this._fontSize = 16, this.rendererManager = new aA(), this.eventEmitter = new F(), this.postSetupFunction = null, this.postDrawFunction = null;
  }
  /**
...
function nA(s) {
  a.prototype.preloadAsciiFont = function() {
    this._incrementPreload(), this.loadAsciiFont(EA);
...
function lA(s, A, e, r, i, o) {
  ...
  const B = Object.keys(s.gradientParams[A]), h = Object.keys(o).filter((d) => !B.includes(d));
  if (h.length > 0)
    throw new Q(
...
const n = new gA();
typeof window < "u" && (window.p5asciify = n, window.preload = function() {
});
QA(n);
nA(n);
hA(n);
