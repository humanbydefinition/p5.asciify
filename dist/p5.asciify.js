(function (global, factory) {
    ...
    class P5AsciifyEffectManager {
        ...
        setupShaders() {
            for (let effectName in this.effectShaders) {
                this.effectShaders[effectName] = this.p5Instance.createShader(vertex2Shader, this.effectShaders[effectName]);
            }
        }
    ...
    class BrightnessAsciiRenderer extends AsciiRenderer {
        ...
        constructor(p5Instance, grid, characterSet, options) {
            ...
            this.shader = this.p5.createShader(vertex1Shader, asciiBrightnessShader);
