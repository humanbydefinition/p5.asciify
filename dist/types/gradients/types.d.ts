...
export type GradientConstructorMap = Record<GradientType, (p: p5, fontTextureAtlas: P5AsciifyFontTextureAtlas, shader: p5.Shader, characters: string, brightnessStart: number, brightnessEnd: number, params: any) => P5AsciifyGradient>;
