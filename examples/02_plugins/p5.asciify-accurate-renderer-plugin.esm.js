...
var m = (e, r, t) => r in e ? g(e, r, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[r] = t;
var i = (e, r, t) => m(e, typeof r != "symbol" ? r + "" : r, t);
import { renderers as d } from "p5.asciify";
const h = (e) => `
...
class S extends d.renderer2d.feature.AbstractFeatureRenderer2D {
  /**
  ...
  resetShaders() {
    this._characterSelectionShader = this._p.createShader(a, h(this._fontManager.fontSize)), this._brightnessSampleShader = this._p.createShader(a, l(this._grid.cellHeight, this._grid.cellWidth)), this._colorSampleShader = this._p.createShader(a, u(16, this._grid.cellHeight, this._grid.cellWidth));
  }
  render() {
